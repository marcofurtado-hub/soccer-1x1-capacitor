...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:Rn,depthTest:!1,depthWrite:!1})}function Nm(i,t,e){const n=new Float32Array(ai),s=new N(0,1,0);return new _n({name:"SphericalGaussianBlur",defines:{n:ai,CUBEUV_TEXEL_WIDTH:1/t,CUBEUV_TEXEL_HEIGHT:1/e,CUBEUV_MAX_MIP:`${i}.0`},uniforms:{envMap:{value:null},samples:{value:1},weights:{value:n},latitudinal:{value:!1},dTheta:{value:0},mipInt:{value:0},poleAxis:{value:s}},vertexShader:_r(),fragmentShader:`
	...
	`}class hh extends fn{constructor(t=1,e={}){super(t,t,e),this.isWebGLCubeRenderTarget=!0;const n={width:t,height:t,depth:1},s=[n,n,n,n,n,n];this.texture=new sh(s),this._setTextureOptions(e),this.texture.isRenderTargetTexture=!0}fromEquirectangularTexture(t,e){this.texture.type=e.type,this.texture.colorSpace=e.colorSpace,this.texture.generateMipmaps=e.generateMipmaps,this.texture.minFilter=e.minFilter,this.texture.magFilter=e.magFilter;const n={uniforms:{tEquirect:{value:null}},vertexShader:`
...
`)}function Xg(i,t){const e={},n=i.getProgramParameter(t,i.ACTIVE_ATTRIBUTES);for(let s=0;s<n;s++){const r=i.getActiveAttrib(t,s),a=r.name;let o=1;r.type===i.FLOAT_MAT2&&(o=2),r.type===i.FLOAT_MAT3&&(o=3),r.type===i.FLOAT_MAT4&&(o=4),e[a]={type:r.type,location:i.getAttribLocation(t,a),locationSize:o}}return e}function rs(i){return i!==""}function nc(i,t){const e=t.numSpotLightShadows+t.numSpotLightMaps-t.numSpotLightShadowsWithMaps;return i.replace(/NUM_DIR_LIGHTS/g,t.numDirLights).replace(/NUM_SPOT_LIGHTS/g,t.numSpotLights).replace(/NUM_SPOT_LIGHT_MAPS/g,t.numSpotLightMaps).replace(/NUM_SPOT_LIGHT_COORDS/g,e).replace(/NUM_RECT_AREA_LIGHTS/g,t.numRectAreaLights).replace(/NUM_POINT_LIGHTS/g,t.numPointLights).replace(/NUM_HEMI_LIGHTS/g,t.numHemiLights).replace(/NUM_DIR_LIGHT_SHADOWS/g,t.numDirLightShadows).replace(/NUM_SPOT_LIGHT_SHADOWS_WITH_MAPS/g,t.numSpotLightShadowsWithMaps).replace(/NUM_SPOT_LIGHT_SHADOWS/g,t.numSpotLightShadows).replace(/NUM_POINT_LIGHT_SHADOWS/g,t.numPointLightShadows)}function ic(i,t){return i.replace(/NUM_CLIPPING_PLANES/g,t.numClippingPlanes).replace(/UNION_CLIPPING_PLANES/g,t.numClippingPlanes-t.numClipIntersection)}const qg=/^[ \t]*#include +<([\w\d./]+)>/gm;function co(i){return i.replace(qg,$g)}const Yg=new Map;function $g(i,t){let e=Ot[t];if(e===void 0){const n=Yg.get(t);if(n!==void 0)e=Ot[n],Lt('WebGLRenderer: Shader chunk "%s" has been deprecated. Use "%s" instead.',t,n);else throw new Error("Can not resolve #include <"+t+">")}return co(e)}const Kg=/#pragma unroll_loop_start\s+for\s*\(\s*int\s+i\s*=\s*(\d+)\s*;\s*i\s*<\s*(\d+)\s*;\s*i\s*\+\+\s*\)\s*{([\s\S]+?)}\s+#pragma unroll_loop_end/g;function sc(i){return i.replace(Kg,Zg)}function Zg(i,t,e,n){let s="";for(let r=parseInt(t);r<parseInt(e);r++)s+=n.replace(/\[\s*i\s*\]/g,"[ "+r+" ]").replace(/UNROLLED_LOOP_INDEX/g,r);return s}function rc(i){let t=`precision ${i.precision} float;
...
#define LOW_PRECISION`),t}const jg={[ir]:"SHADOWMAP_TYPE_PCF",[ss]:"SHADOWMAP_TYPE_VSM"};function Jg(i){return jg[i.shadowMapType]||"SHADOWMAP_TYPE_BASIC"}const Qg={[ci]:"ENVMAP_TYPE_CUBE",[ki]:"ENVMAP_TYPE_CUBE",[gr]:"ENVMAP_TYPE_CUBE_UV"};function t0(i){return i.envMap===!1?"ENVMAP_TYPE_CUBE":Qg[i.envMapMode]||"ENVMAP_TYPE_CUBE"}const e0={[ki]:"ENVMAP_MODE_REFRACTION"};function n0(i){return i.envMap===!1?"ENVMAP_MODE_REFLECTION":e0[i.envMapMode]||"ENVMAP_MODE_REFLECTION"}const i0={[go]:"ENVMAP_BLENDING_MULTIPLY",[zu]:"ENVMAP_BLENDING_MIX",[ku]:"ENVMAP_BLENDING_ADD"};function s0(i){return i.envMap===!1?"ENVMAP_BLENDING_NONE":i0[i.combine]||"ENVMAP_BLENDING_NONE"}function r0(i){const t=i.envMapCubeUVHeight;if(t===null)return null;const e=Math.log2(t)-2,n=1/t;return{texelWidth:1/(3*Math.max(Math.pow(2,e),112)),texelHeight:n,maxMip:e}}function a0(i,t,e,n){const s=i.getContext(),r=e.defines;let a=e.vertexShader,o=e.fragmentShader;const c=Jg(e),l=t0(e),h=n0(e),d=s0(e),u=r0(e),p=Hg(e),g=Wg(r),x=s.createProgram();let m,f,y=e.glslVersion?"#version "+e.glslVersion+`
...
`)+`
`+f);const T=y+m+a,E=y+f+o,w=Ql(s,s.VERTEX_SHADER,T),b=Ql(s,s.FRAGMENT_SHADER,E);s.attachShader(x,w),s.attachShader(x,b),e.index0AttributeName!==void 0?s.bindAttribLocation(x,0,e.index0AttributeName):e.morphTargets===!0&&s.bindAttribLocation(x,0,"position"),s.linkProgram(x);function R(C){if(i.debug.checkShaderErrors){const U=s.getProgramInfoLog(x)||"",F=s.getShaderInfoLog(w)||"",H=s.getShaderInfoLog(b)||"",B=U.trim(),k=F.trim(),G=H.trim();let Q=!0,Z=!0;if(s.getProgramParameter(x,s.LINK_STATUS)===!1)if(Q=!1,typeof i.debug.onShaderError=="function")i.debug.onShaderError(s,x,w,b);else{const ct=ec(s,w,"vertex"),mt=ec(s,b,"fragment");Xt("THREE.WebGLProgram: Shader Error "+s.getError()+" - VALIDATE_STATUS "+s.getProgramParameter(x,s.VALIDATE_STATUS)+`
...
void main() {
    ...
    `,i.appendChild(r)}),Gt("lb-reset").textContent=`reset em ${P_(A_())}`,xs("leaderboard");const e=i.querySelector(".lb-row.player");e&&setTimeout(()=>e.scrollIntoView({block:"center",behavior:"smooth"}),80)}function U_(){const i=Gt("ad-content"),t=Gt("ad-sub"),e=Gt("ad-progress-fill"),n=Gt("ad-skip"),s=Gt("ad-reward"),r=Gt("ad-actions"),a=Gt("ad-claim");i.innerHTML="ANÚNCIO<br>EM PROGRESSO",t.textContent="segure firme — quase lá",e.style.width="0%",s.classList.remove("show"),r.classList.remove("show"),n.textContent="SKIP em 5s",xs("ads-overlay");const o=5e3,c=performance.now();Hn&&clearInterval(Hn),Hn=setInterval(()=>{const l=performance.now()-c,h=Math.min(100,l/o*100);e.style.width=h+"%";const d=Math.max(0,Math.ceil((o-l)/1e3));if(n.textContent=d>0?`SKIP em ${d}s`:"",l>=o){clearInterval(Hn),Hn=null;const u=R_();i.innerHTML=u?"ANÚNCIO<br>COMPLETO":"INGRESSOS<br>NO MÁXIMO",t.textContent=u?"recompensa pronta":"volte quando gastar ingressos",u&&(s.textContent=`+${Lo} 🎫`,s.classList.add("show")),r.classList.add("show"),a.textContent="OK"}},100)}function N_(){Hn&&(clearInterval(Hn),Hn=null),os()}function F_(){Gt("lobby-play").addEventListener("click",()=>{if(!y_()){ho();return}ur(),Pc(()=>{pa(),wn.startMatch()})}),Gt("lobby-ads").addEventListener("click",()=>{Sh()&&(ur(),U_())}),Gt("lobby-leaderboard").addEventListener("click",()=>{ur(),D_()}),Gt("lb-close").addEventListener("click",()=>os()),Gt("lb-back").addEventListener("click",()=>os()),Gt("ad-claim").addEventListener("click",()=>N_()),Gt("endcard-lobby").addEventListener("click",()=>{wn.exitToMenu(),os()}),Gt("endcard-replay").addEventListener("click",()=>{pa(),wn.exitToMenu(),Pc(()=>{pa(),wn.startMatch()})})}function O_(){window.__onMatchOver=i=>{L_(i)}}function B_(i){const t=g_();wn=window.__GAME__||window.__game,wn||console.error("[meta] startSoccer did not expose the game instance"),i&&i.classList.add("visible");const e=document.getElementById("game-canvas");return e&&e.classList.add("visible"),O_(),F_(),os(),t}const z_=document.getElementById("game-canvas"),ve=(...i)=>console.log("[Shell]",...i);async function Eh(){ve("Booting...",`platform=${qn.getPlatform()}`,`native=${qn.isNativePlatform()}`);try{await nl().initialize({appId:"Soccer 1x1",environment:"production"}),ve("[WildlifePlatform] initialized, version =",await nl().getPlatformVersion())}catch(t){ve("[WildlifePlatform] initialize failed:",(t==null?void 0:t.message)??t)}lu(),fu();let i="1.0.0";if(qn.isNativePlatform()){try{const t=await Lc.getInfo();i=t.version||i,ve("Native app info:",JSON.stringify(t))}catch(t){ve("Could not get native app info:",t.message)}ve("Entering fullscreen mode..."),await $o.hide(),await $o.setOverlaysWebView({overlay:!0}),await Vh.hide(),ve("Fullscreen + splash hidden")}cu(i),ve("Shell version:",i,"| Content version:","1.0.0"),Un.on("status",t=>{ve("OTA status:",t),bs(t)}),Un.on("progress",t=>{ve("OTA progress:",t+"%"),al(t)}),Un.on("error",t=>ve("OTA error:",t));try{ve("Initializing OTA updater..."),await Un.init(),ve("OTA updater initialized");const t=await Un.getContentVersion();ve("Content version:",t),hu(t),ve("Checking for updates...");const e=await Un.checkForUpdate();if(e){ve("Update manifest:",JSON.stringify(e)),bs("Downloading update..."),await Un.downloadUpdate(e),bs("Applying update..."),ve("Applying update immediately..."),await Un.applyNow();return}else ve("No update available");bs("Starting game..."),al(100),ve("Launching game..."),await k_(300),B_(z_),ve("Lobby ready — hiding loader"),await du(),ve("Boot complete")}catch(t){console.error("[Shell] Startup error:",t),pu(t.message||"Failed to start the game.",()=>Eh())}}function k_(i){return new Promise(t=>setTimeout(t,i))}Eh();export{Ic as W};
