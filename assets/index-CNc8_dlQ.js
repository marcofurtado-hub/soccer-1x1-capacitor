...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:Rn,depthTest:!1,depthWrite:!1})}function ql(){return new vn({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:_r(),fragmentShader:`
		...
		`,blending:Rn,depthTest:!1,depthWrite:!1})}function Yl(){return new vn({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:_r(),fragmentShader:`
...
}`,y0=[new N(1,0,0),new N(-1,0,0),new N(0,1,0),new N(0,-1,0),new N(0,0,1),new N(0,0,-1)],b0=[new N(0,-1,0),new N(0,-1,0),new N(0,0,1),new N(0,0,-1),new N(0,-1,0),new N(0,-1,0)],hc=new fe,ns=new N,aa=new N;function E0(i,t,e){let n=new Ro;const s=new Ht,r=new Ht,a=new me,o=new Pd,c=new Id,l={},h=e.maxTextureSize,d={[Yn]:Ve,[Ve]:Yn,[ze]:ze},u=new vn({defines:{VSM_SAMPLES:8},uniforms:{shadow_pass:{value:null},resolution:{value:new Ht},radius:{value:4}},vertexShader:M0,fragmentShader:S0}),p=u.clone();p.defines.HORIZONTAL_PASS=1;const g=new He;g.setAttribute("position",new mn(new Float32Array([-1,-1,.5,3,-1,.5,-1,3,.5]),3));const x=new ct(g,u),m=this;this.enabled=!1,this.autoUpdate=!0,this.needsUpdate=!1,this.type=ir;let f=this.type;this.render=function(E,C,_){if(m.enabled===!1||m.autoUpdate===!1&&m.needsUpdate===!1||E.length===0)return;this.type===Mu&&(Lt("WebGLShadowMap: PCFSoftShadowMap has been deprecated. Using PCFShadowMap instead."),this.type=ir);const S=i.getRenderTarget(),O=i.getActiveCubeFace(),R=i.getActiveMipmapLevel(),U=i.state;U.setBlending(Rn),U.buffers.depth.getReversed()===!0?U.buffers.color.setClear(0,0,0,0):U.buffers.color.setClear(1,1,1,1),U.buffers.depth.setTest(!0),U.setScissorTest(!1);const F=f!==this.type;F&&C.traverse(function(H){H.material&&(Array.isArray(H.material)?H.material.forEach(B=>B.needsUpdate=!0):H.material.needsUpdate=!0)});for(let H=0,B=E.length;H<B;H++){const k=E[H],G=k.shadow;if(G===void 0){Lt("WebGLShadowMap:",k,"has no shadow.");continue}if(G.autoUpdate===!1&&G.needsUpdate===!1)continue;s.copy(G.mapSize);const Q=G.getFrameExtents();s.multiply(Q),r.copy(G.mapSize),(s.x>h||s.y>h)&&(s.x>h&&(r.x=Math.floor(h/Q.x),s.x=r.x*Q.x,G.mapSize.x=r.x),s.y>h&&(r.y=Math.floor(h/Q.y),s.y=r.y*Q.y,G.mapSize.y=r.y));const Z=i.state.buffers.depth.getReversed();if(G.camera._reversedDepth=Z,G.map===null||F===!0){if(G.map!==null&&(G.map.depthTexture!==null&&(G.map.depthTexture.dispose(),G.map.depthTexture=null),G.map.dispose()),this.type===rs){if(k.isPointLight){Lt("WebGLShadowMap: VSM shadow maps are not supported for PointLights. Use PCF or BasicShadowMap instead.");continue}G.map=new pn(s.x,s.y,{format:Vi,type:In,minFilter:Ne,magFilter:Ne,generateMipmaps:!1}),G.map.texture.name=k.name+".shadowMap",G.map.depthTexture=new ds(s.x,s.y,un),G.map.depthTexture.name=k.name+".shadowMapDepth",G.map.depthTexture.format=Ln,G.map.depthTexture.compareFunction=null,G.map.depthTexture.minFilter=Re,G.map.depthTexture.magFilter=Re}else k.isPointLight?(G.map=new hh(s.x),G.map.depthTexture=new Ed(s.x,gn)):(G.map=new pn(s.x,s.y),G.map.depthTexture=new ds(s.x,s.y,gn)),G.map.depthTexture.name=k.name+".shadowMap",G.map.depthTexture.format=Ln,this.type===ir?(G.map.depthTexture.compareFunction=Z?To:Eo,G.map.depthTexture.minFilter=Ne,G.map.depthTexture.magFilter=Ne):(G.map.depthTexture.compareFunction=null,G.map.depthTexture.minFilter=Re,G.map.depthTexture.magFilter=Re);G.camera.updateProjectionMatrix()}const ht=G.map.isWebGLCubeRenderTarget?6:1;for(let mt=0;mt<ht;mt++){if(G.map.isWebGLCubeRenderTarget)i.setRenderTarget(G.map,mt),i.clear();else{mt===0&&(i.setRenderTarget(G.map),i.clear());const dt=G.getViewport(mt);a.set(r.x*dt.x,r.y*dt.y,r.x*dt.z,r.y*dt.w),U.viewport(a)}if(k.isPointLight){const dt=G.camera,Ft=G.matrix,ce=k.distance||dt.far;ce!==dt.far&&(dt.far=ce,dt.updateProjectionMatrix()),ns.setFromMatrixPosition(k.matrixWorld),dt.position.copy(ns),aa.copy(dt.position),aa.add(y0[mt]),dt.up.copy(b0[mt]),dt.lookAt(aa),dt.updateMatrixWorld(),Ft.makeTranslation(-ns.x,-ns.y,-ns.z),hc.multiplyMatrices(dt.projectionMatrix,dt.matrixWorldInverse),G._frustum.setFromProjectionMatrix(hc,dt.coordinateSystem,dt.reversedDepth)}else G.updateMatrices(k);n=G.getFrustum(),b(C,_,G.camera,k,this.type)}G.isPointLightShadow!==!0&&this.type===rs&&y(G,_),G.needsUpdate=!1}f=this.type,m.needsUpdate=!1,i.setRenderTarget(S,O,R)};function y(E,C){const _=t.update(x);u.defines.VSM_SAMPLES!==E.blurSamples&&(u.defines.VSM_SAMPLES=E.blurSamples,p.defines.VSM_SAMPLES=E.blurSamples,u.needsUpdate=!0,p.needsUpdate=!0),E.mapPass===null&&(E.mapPass=new pn(s.x,s.y,{format:Vi,type:In})),u.uniforms.shadow_pass.value=E.map.depthTexture,u.uniforms.resolution.value=E.mapSize,u.uniforms.radius.value=E.radius,i.setRenderTarget(E.mapPass),i.clear(),i.renderBufferDirect(C,null,_,u,x,null),p.uniforms.shadow_pass.value=E.mapPass.texture,p.uniforms.resolution.value=E.mapSize,p.uniforms.radius.value=E.radius,i.setRenderTarget(E.map),i.clear(),i.renderBufferDirect(C,null,_,p,x,null)}function T(E,C,_,S){let O=null;const R=_.isPointLight===!0?E.customDistanceMaterial:E.customDepthMaterial;if(R!==void 0)O=R;else if(O=_.isPointLight===!0?c:o,i.localClippingEnabled&&C.clipShadows===!0&&Array.isArray(C.clippingPlanes)&&C.clippingPlanes.length!==0||C.displacementMap&&C.displacementScale!==0||C.alphaMap&&C.alphaTest>0||C.map&&C.alphaTest>0||C.alphaToCoverage===!0){const U=O.uuid,F=C.uuid;let H=l[U];H===void 0&&(H={},l[U]=H);let B=H[F];B===void 0&&(B=O.clone(),H[F]=B,C.addEventListener("dispose",w)),O=B}if(O.visible=C.visible,O.wireframe=C.wireframe,S===rs?O.side=C.shadowSide!==null?C.shadowSide:C.side:O.side=C.shadowSide!==null?C.shadowSide:d[C.side],O.alphaMap=C.alphaMap,O.alphaTest=C.alphaToCoverage===!0?.5:C.alphaTest,O.map=C.map,O.clipShadows=C.clipShadows,O.clippingPlanes=C.clippingPlanes,O.clipIntersection=C.clipIntersection,O.displacementMap=C.displacementMap,O.displacementScale=C.displacementScale,O.displacementBias=C.displacementBias,O.wireframeLinewidth=C.wireframeLinewidth,O.linewidth=C.linewidth,_.isPointLight===!0&&O.isMeshDistanceMaterial===!0){const U=i.properties.get(O);U.light=_}return O}function b(E,C,_,S,O){if(E.visible===!1)return;if(E.layers.test(C.layers)&&(E.isMesh||E.isLine||E.isPoints)&&(E.castShadow||E.receiveShadow&&O===rs)&&(!E.frustumCulled||n.intersectsObject(E))){E.modelViewMatrix.multiplyMatrices(_.matrixWorldInverse,E.matrixWorld);const F=t.update(E),H=E.material;if(Array.isArray(H)){const B=F.groups;for(let k=0,G=B.length;k<G;k++){const Q=B[k],Z=H[Q.materialIndex];if(Z&&Z.visible){const ht=T(E,Z,S,O);E.onBeforeShadow(i,E,C,_,F,ht,Q),i.renderBufferDirect(_,null,F,ht,E,Q),E.onAfterShadow(i,E,C,_,F,ht,Q)}}}else if(H.visible){const B=T(E,H,S,O);E.onBeforeShadow(i,E,C,_,F,B,null),i.renderBufferDirect(_,null,F,B,E,null),E.onAfterShadow(i,E,C,_,F,B,null)}}const U=E.children;for(let F=0,H=U.length;F<H;F++)b(U[F],C,_,S,O)}function w(E){E.target.removeEventListener("dispose",w);for(const _ in l){const S=l[_],O=E.target.uuid;O in S&&(S[O].dispose(),delete S[O])}}}function T0(i,t){function e(){let I=!1;const st=new me;let et=null;const pt=new me(0,0,0,0);return{setMask:function(J){et!==J&&!I&&(i.colorMask(J,J,J,J),et=J)},setLocked:function(J){I=J},setClear:function(J,X,vt,It,ae){ae===!0&&(J*=It,X*=It,vt*=It),st.set(J,X,vt,It),pt.equals(st)===!1&&(i.clearColor(J,X,vt,It),pt.copy(st))},reset:function(){I=!1,et=null,pt.set(-1,0,0,0)}}}function n(){let I=!1,st=!1,et=null,pt=null,J=null;return{setReversed:function(X){if(st!==X){const vt=t.get("EXT_clip_control");X?vt.clipControlEXT(vt.LOWER_LEFT_EXT,vt.ZERO_TO_ONE_EXT):vt.clipControlEXT(vt.LOWER_LEFT_EXT,vt.NEGATIVE_ONE_TO_ONE_EXT),st=X;const It=J;J=null,this.setClear(It)}},getReversed:function(){return st},setTest:function(X){X?nt(i.DEPTH_TEST):rt(i.DEPTH_TEST)},setMask:function(X){et!==X&&!I&&(i.depthMask(X),et=X)},setFunc:function(X){if(st&&(X=Qu[X]),pt!==X){switch(X){case Ma:i.depthFunc(i.NEVER);break;case Sa:i.depthFunc(i.ALWAYS);break;case ya:i.depthFunc(i.LESS);break;case ki:i.depthFunc(i.LEQUAL);break;case ba:i.depthFunc(i.EQUAL);break;case Ea:i.depthFunc(i.GEQUAL);break;case Ta:i.depthFunc(i.GREATER);break;case Aa:i.depthFunc(i.NOTEQUAL);break;default:i.depthFunc(i.LEQUAL)}pt=X}},setLocked:function(X){I=X},setClear:function(X){J!==X&&(J=X,st&&(X=1-X),i.clearDepth(X))},reset:function(){I=!1,et=null,pt=null,J=null,st=!1}}}function s(){let I=!1,st=null,et=null,pt=null,J=null,X=null,vt=null,It=null,ae=null;return{setTest:function(Qt){I||(Qt?nt(i.STENCIL_TEST):rt(i.STENCIL_TEST))},setMask:function(Qt){st!==Qt&&!I&&(i.stencilMask(Qt),st=Qt)},setFunc:function(Qt,xn,Mn){(et!==Qt||pt!==xn||J!==Mn)&&(i.stencilFunc(Qt,xn,Mn),et=Qt,pt=xn,J=Mn)},setOp:function(Qt,xn,Mn){(X!==Qt||vt!==xn||It!==Mn)&&(i.stencilOp(Qt,xn,Mn),X=Qt,vt=xn,It=Mn)},setLocked:function(Qt){I=Qt},setClear:function(Qt){ae!==Qt&&(i.clearStencil(Qt),ae=Qt)},reset:function(){I=!1,st=null,et=null,pt=null,J=null,X=null,vt=null,It=null,ae=null}}}const r=new e,a=new n,o=new s,c=new WeakMap,l=new WeakMap;let h={},d={},u=new WeakMap,p=[],g=null,x=!1,m=null,f=null,y=null,T=null,b=null,w=null,E=null,C=new Kt(0,0,0),_=0,S=!1,O=null,R=null,U=null,F=null,H=null;const B=i.getParameter(i.MAX_COMBINED_TEXTURE_IMAGE_UNITS);let k=!1,G=0;const Q=i.getParameter(i.VERSION);Q.indexOf("WebGL")!==-1?(G=parseFloat(/^WebGL (\d)/.exec(Q)[1]),k=G>=1):Q.indexOf("OpenGL ES")!==-1&&(G=parseFloat(/^OpenGL ES (\d)/.exec(Q)[1]),k=G>=2);let Z=null,ht={};const mt=i.getParameter(i.SCISSOR_BOX),dt=i.getParameter(i.VIEWPORT),Ft=new me().fromArray(mt),ce=new me().fromArray(dt);function le(I,st,et,pt){const J=new Uint8Array(4),X=i.createTexture();i.bindTexture(I,X),i.texParameteri(I,i.TEXTURE_MIN_FILTER,i.NEAREST),i.texParameteri(I,i.TEXTURE_MAG_FILTER,i.NEAREST);for(let vt=0;vt<et;vt++)I===i.TEXTURE_3D||I===i.TEXTURE_2D_ARRAY?i.texImage3D(st,0,i.RGBA,1,1,pt,0,i.RGBA,i.UNSIGNED_BYTE,J):i.texImage2D(st+vt,0,i.RGBA,1,1,0,i.RGBA,i.UNSIGNED_BYTE,J);return X}const $={};$[i.TEXTURE_2D]=le(i.TEXTURE_2D,i.TEXTURE_2D,1),$[i.TEXTURE_CUBE_MAP]=le(i.TEXTURE_CUBE_MAP,i.TEXTURE_CUBE_MAP_POSITIVE_X,6),$[i.TEXTURE_2D_ARRAY]=le(i.TEXTURE_2D_ARRAY,i.TEXTURE_2D_ARRAY,1,1),$[i.TEXTURE_3D]=le(i.TEXTURE_3D,i.TEXTURE_3D,1,1),r.setClear(0,0,0,1),a.setClear(1),o.setClear(0),nt(i.DEPTH_TEST),a.setFunc(ki),Bt(!1),ge(hl),nt(i.CULL_FACE),Jt(Rn);function nt(I){h[I]!==!0&&(i.enable(I),h[I]=!0)}function rt(I){h[I]!==!1&&(i.disable(I),h[I]=!1)}function Ut(I,st){return d[I]!==st?(i.bindFramebuffer(I,st),d[I]=st,I===i.DRAW_FRAMEBUFFER&&(d[i.FRAMEBUFFER]=st),I===i.FRAMEBUFFER&&(d[i.DRAW_FRAMEBUFFER]=st),!0):!1}function wt(I,st){let et=p,pt=!1;if(I){et=u.get(st),et===void 0&&(et=[],u.set(st,et));const J=I.textures;if(et.length!==J.length||et[0]!==i.COLOR_ATTACHMENT0){for(let X=0,vt=J.length;X<vt;X++)et[X]=i.COLOR_ATTACHMENT0+X;et.length=J.length,pt=!0}}else et[0]!==i.BACK&&(et[0]=i.BACK,pt=!0);pt&&i.drawBuffers(et)}function Pt(I){return g!==I?(i.useProgram(I),g=I,!0):!1}const Te={[si]:i.FUNC_ADD,[yu]:i.FUNC_SUBTRACT,[bu]:i.FUNC_REVERSE_SUBTRACT};Te[Eu]=i.MIN,Te[Tu]=i.MAX;const Wt={[Au]:i.ZERO,[wu]:i.ONE,[Cu]:i.SRC_COLOR,[va]:i.SRC_ALPHA,[Uu]:i.SRC_ALPHA_SATURATE,[Lu]:i.DST_COLOR,[Pu]:i.DST_ALPHA,[Ru]:i.ONE_MINUS_SRC_COLOR,[xa]:i.ONE_MINUS_SRC_ALPHA,[Du]:i.ONE_MINUS_DST_COLOR,[Iu]:i.ONE_MINUS_DST_ALPHA,[Nu]:i.CONSTANT_COLOR,[Fu]:i.ONE_MINUS_CONSTANT_COLOR,[Ou]:i.CONSTANT_ALPHA,[Bu]:i.ONE_MINUS_CONSTANT_ALPHA};function Jt(I,st,et,pt,J,X,vt,It,ae,Qt){if(I===Rn){x===!0&&(rt(i.BLEND),x=!1);return}if(x===!1&&(nt(i.BLEND),x=!0),I!==Su){if(I!==m||Qt!==S){if((f!==si||b!==si)&&(i.blendEquation(i.FUNC_ADD),f=si,b=si),Qt)switch(I){case Fi:i.blendFuncSeparate(i.ONE,i.ONE_MINUS_SRC_ALPHA,i.ONE,i.ONE_MINUS_SRC_ALPHA);break;case ul:i.blendFunc(i.ONE,i.ONE);break;case dl:i.blendFuncSeparate(i.ZERO,i.ONE_MINUS_SRC_COLOR,i.ZERO,i.ONE);break;case fl:i.blendFuncSeparate(i.DST_COLOR,i.ONE_MINUS_SRC_ALPHA,i.ZERO,i.ONE);break;default:Xt("WebGLState: Invalid blending: ",I);break}else switch(I){case Fi:i.blendFuncSeparate(i.SRC_ALPHA,i.ONE_MINUS_SRC_ALPHA,i.ONE,i.ONE_MINUS_SRC_ALPHA);break;case ul:i.blendFuncSeparate(i.SRC_ALPHA,i.ONE,i.ONE,i.ONE);break;case dl:Xt("WebGLState: SubtractiveBlending requires material.premultipliedAlpha = true");break;case fl:Xt("WebGLState: MultiplyBlending requires material.premultipliedAlpha = true");break;default:Xt("WebGLState: Invalid blending: ",I);break}y=null,T=null,w=null,E=null,C.set(0,0,0),_=0,m=I,S=Qt}return}J=J||st,X=X||et,vt=vt||pt,(st!==f||J!==b)&&(i.blendEquationSeparate(Te[st],Te[J]),f=st,b=J),(et!==y||pt!==T||X!==w||vt!==E)&&(i.blendFuncSeparate(Wt[et],Wt[pt],Wt[X],Wt[vt]),y=et,T=pt,w=X,E=vt),(It.equals(C)===!1||ae!==_)&&(i.blendColor(It.r,It.g,It.b,ae),C.copy(It),_=ae),m=I,S=!1}function ie(I,st){I.side===ze?rt(i.CULL_FACE):nt(i.CULL_FACE);let et=I.side===Ve;st&&(et=!et),Bt(et),I.blending===Fi&&I.transparent===!1?Jt(Rn):Jt(I.blending,I.blendEquation,I.blendSrc,I.blendDst,I.blendEquationAlpha,I.blendSrcAlpha,I.blendDstAlpha,I.blendColor,I.blendAlpha,I.premultipliedAlpha),a.setFunc(I.depthFunc),a.setTest(I.depthTest),a.setMask(I.depthWrite),r.setMask(I.colorWrite);const pt=I.stencilWrite;o.setTest(pt),pt&&(o.setMask(I.stencilWriteMask),o.setFunc(I.stencilFunc,I.stencilRef,I.stencilFuncMask),o.setOp(I.stencilFail,I.stencilZFail,I.stencilZPass)),Me(I.polygonOffset,I.polygonOffsetFactor,I.polygonOffsetUnits),I.alphaToCoverage===!0?nt(i.SAMPLE_ALPHA_TO_COVERAGE):rt(i.SAMPLE_ALPHA_TO_COVERAGE)}function Bt(I){O!==I&&(I?i.frontFace(i.CW):i.frontFace(i.CCW),O=I)}function ge(I){I!==vu?(nt(i.CULL_FACE),I!==R&&(I===hl?i.cullFace(i.BACK):I===xu?i.cullFace(i.FRONT):i.cullFace(i.FRONT_AND_BACK))):rt(i.CULL_FACE),R=I}function P(I){I!==U&&(k&&i.lineWidth(I),U=I)}function Me(I,st,et){I?(nt(i.POLYGON_OFFSET_FILL),(F!==st||H!==et)&&(F=st,H=et,a.getReversed()&&(st=-st),i.polygonOffset(st,et))):rt(i.POLYGON_OFFSET_FILL)}function Zt(I){I?nt(i.SCISSOR_TEST):rt(i.SCISSOR_TEST)}function re(I){I===void 0&&(I=i.TEXTURE0+B-1),Z!==I&&(i.activeTexture(I),Z=I)}function St(I,st,et){et===void 0&&(Z===null?et=i.TEXTURE0+B-1:et=Z);let pt=ht[et];pt===void 0&&(pt={type:void 0,texture:void 0},ht[et]=pt),(pt.type!==I||pt.texture!==st)&&(Z!==et&&(i.activeTexture(et),Z=et),i.bindTexture(I,st||$[I]),pt.type=I,pt.texture=st)}function A(){const I=ht[Z];I!==void 0&&I.type!==void 0&&(i.bindTexture(I.type,null),I.type=void 0,I.texture=void 0)}function v(){try{i.compressedTexImage2D(...arguments)}catch(I){Xt("WebGLState:",I)}}function L(){try{i.compressedTexImage3D(...arguments)}catch(I){Xt("WebGLState:",I)}}function Y(){try{i.texSubImage2D(...arguments)}catch(I){Xt("WebGLState:",I)}}function K(){try{i.texSubImage3D(...arguments)}catch(I){Xt("WebGLState:",I)}}function q(){try{i.compressedTexSubImage2D(...arguments)}catch(I){Xt("WebGLState:",I)}}function gt(){try{i.compressedTexSubImage3D(...arguments)}catch(I){Xt("WebGLState:",I)}}function it(){try{i.texStorage2D(...arguments)}catch(I){Xt("WebGLState:",I)}}function Tt(){try{i.texStorage3D(...arguments)}catch(I){Xt("WebGLState:",I)}}function Ct(){try{i.texImage2D(...arguments)}catch(I){Xt("WebGLState:",I)}}function j(){try{i.texImage3D(...arguments)}catch(I){Xt("WebGLState:",I)}}function tt(I){Ft.equals(I)===!1&&(i.scissor(I.x,I.y,I.z,I.w),Ft.copy(I))}function _t(I){ce.equals(I)===!1&&(i.viewport(I.x,I.y,I.z,I.w),ce.copy(I))}function xt(I,st){let et=l.get(st);et===void 0&&(et=new WeakMap,l.set(st,et));let pt=et.get(I);pt===void 0&&(pt=i.getUniformBlockIndex(st,I.name),et.set(I,pt))}function ut(I,st){const pt=l.get(st).get(I);c.get(st)!==pt&&(i.uniformBlockBinding(st,pt,I.__bindingPointIndex),c.set(st,pt))}function zt(){i.disable(i.BLEND),i.disable(i.CULL_FACE),i.disable(i.DEPTH_TEST),i.disable(i.POLYGON_OFFSET_FILL),i.disable(i.SCISSOR_TEST),i.disable(i.STENCIL_TEST),i.disable(i.SAMPLE_ALPHA_TO_COVERAGE),i.blendEquation(i.FUNC_ADD),i.blendFunc(i.ONE,i.ZERO),i.blendFuncSeparate(i.ONE,i.ZERO,i.ONE,i.ZERO),i.blendColor(0,0,0,0),i.colorMask(!0,!0,!0,!0),i.clearColor(0,0,0,0),i.depthMask(!0),i.depthFunc(i.LESS),a.setReversed(!1),i.clearDepth(1),i.stencilMask(4294967295),i.stencilFunc(i.ALWAYS,0,4294967295),i.stencilOp(i.KEEP,i.KEEP,i.KEEP),i.clearStencil(0),i.cullFace(i.BACK),i.frontFace(i.CCW),i.polygonOffset(0,0),i.activeTexture(i.TEXTURE0),i.bindFramebuffer(i.FRAMEBUFFER,null),i.bindFramebuffer(i.DRAW_FRAMEBUFFER,null),i.bindFramebuffer(i.READ_FRAMEBUFFER,null),i.useProgram(null),i.lineWidth(1),i.scissor(0,0,i.canvas.width,i.canvas.height),i.viewport(0,0,i.canvas.width,i.canvas.height),h={},Z=null,ht={},d={},u=new WeakMap,p=[],g=null,x=!1,m=null,f=null,y=null,T=null,b=null,w=null,E=null,C=new Kt(0,0,0),_=0,S=!1,O=null,R=null,U=null,F=null,H=null,Ft.set(0,0,i.canvas.width,i.canvas.height),ce.set(0,0,i.canvas.width,i.canvas.height),r.reset(),a.reset(),o.reset()}return{buffers:{color:r,depth:a,stencil:o},enable:nt,disable:rt,bindFramebuffer:Ut,drawBuffers:wt,useProgram:Pt,setBlending:Jt,setMaterial:ie,setFlipSided:Bt,setCullFace:ge,setLineWidth:P,setPolygonOffset:Me,setScissorTest:Zt,activeTexture:re,bindTexture:St,unbindTexture:A,compressedTexImage2D:v,compressedTexImage3D:L,texImage2D:Ct,texImage3D:j,updateUBOMapping:xt,uniformBlockBinding:ut,texStorage2D:it,texStorage3D:Tt,texSubImage2D:Y,texSubImage3D:K,compressedTexSubImage2D:q,compressedTexSubImage3D:gt,scissor:tt,viewport:_t,reset:zt}}function A0(i,t,e,n,s,r,a){const o=t.has("WEBGL_multisampled_render_to_texture")?t.get("WEBGL_multisampled_render_to_texture"):null,c=typeof navigator>"u"?!1:/OculusBrowser/g.test(navigator.userAgent),l=new Ht,h=new WeakMap;let d;const u=new WeakMap;let p=!1;try{p=typeof OffscreenCanvas<"u"&&new OffscreenCanvas(1,1).getContext("2d")!==null}catch{}function g(A,v){return p?new OffscreenCanvas(A,v):us("canvas")}function x(A,v,L){let Y=1;const K=St(A);if((K.width>L||K.height>L)&&(Y=L/Math.max(K.width,K.height)),Y<1)if(typeof HTMLImageElement<"u"&&A instanceof HTMLImageElement||typeof HTMLCanvasElement<"u"&&A instanceof HTMLCanvasElement||typeof ImageBitmap<"u"&&A instanceof ImageBitmap||typeof VideoFrame<"u"&&A instanceof VideoFrame){const q=Math.floor(Y*K.width),gt=Math.floor(Y*K.height);d===void 0&&(d=g(q,gt));const it=v?g(q,gt):d;return it.width=q,it.height=gt,it.getContext("2d").drawImage(A,0,0,q,gt),Lt("WebGLRenderer: Texture has been resized from ("+K.width+"x"+K.height+") to ("+q+"x"+gt+")."),it}else return"data"in A&&Lt("WebGLRenderer: Image in DataTexture is too big ("+K.width+"x"+K.height+")."),A;return A}function m(A){return A.generateMipmaps}function f(A){i.generateMipmap(A)}function y(A){return A.isWebGLCubeRenderTarget?i.TEXTURE_CUBE_MAP:A.isWebGL3DRenderTarget?i.TEXTURE_3D:A.isWebGLArrayRenderTarget||A.isCompressedArrayTexture?i.TEXTURE_2D_ARRAY:i.TEXTURE_2D}function T(A,v,L,Y,K=!1){if(A!==null){if(i[A]!==void 0)return i[A];Lt("WebGLRenderer: Attempt to use non-existing WebGL internal format '"+A+"'")}let q=v;if(v===i.RED&&(L===i.FLOAT&&(q=i.R32F),L===i.HALF_FLOAT&&(q=i.R16F),L===i.UNSIGNED_BYTE&&(q=i.R8)),v===i.RED_INTEGER&&(L===i.UNSIGNED_BYTE&&(q=i.R8UI),L===i.UNSIGNED_SHORT&&(q=i.R16UI),L===i.UNSIGNED_INT&&(q=i.R32UI),L===i.BYTE&&(q=i.R8I),L===i.SHORT&&(q=i.R16I),L===i.INT&&(q=i.R32I)),v===i.RG&&(L===i.FLOAT&&(q=i.RG32F),L===i.HALF_FLOAT&&(q=i.RG16F),L===i.UNSIGNED_BYTE&&(q=i.RG8)),v===i.RG_INTEGER&&(L===i.UNSIGNED_BYTE&&(q=i.RG8UI),L===i.UNSIGNED_SHORT&&(q=i.RG16UI),L===i.UNSIGNED_INT&&(q=i.RG32UI),L===i.BYTE&&(q=i.RG8I),L===i.SHORT&&(q=i.RG16I),L===i.INT&&(q=i.RG32I)),v===i.RGB_INTEGER&&(L===i.UNSIGNED_BYTE&&(q=i.RGB8UI),L===i.UNSIGNED_SHORT&&(q=i.RGB16UI),L===i.UNSIGNED_INT&&(q=i.RGB32UI),L===i.BYTE&&(q=i.RGB8I),L===i.SHORT&&(q=i.RGB16I),L===i.INT&&(q=i.RGB32I)),v===i.RGBA_INTEGER&&(L===i.UNSIGNED_BYTE&&(q=i.RGBA8UI),L===i.UNSIGNED_SHORT&&(q=i.RGBA16UI),L===i.UNSIGNED_INT&&(q=i.RGBA32UI),L===i.BYTE&&(q=i.RGBA8I),L===i.SHORT&&(q=i.RGBA16I),L===i.INT&&(q=i.RGBA32I)),v===i.RGB&&(L===i.UNSIGNED_INT_5_9_9_9_REV&&(q=i.RGB9_E5),L===i.UNSIGNED_INT_10F_11F_11F_REV&&(q=i.R11F_G11F_B10F)),v===i.RGBA){const gt=K?pr:qt.getTransfer(Y);L===i.FLOAT&&(q=i.RGBA32F),L===i.HALF_FLOAT&&(q=i.RGBA16F),L===i.UNSIGNED_BYTE&&(q=gt===te?i.SRGB8_ALPHA8:i.RGBA8),L===i.UNSIGNED_SHORT_4_4_4_4&&(q=i.RGBA4),L===i.UNSIGNED_SHORT_5_5_5_1&&(q=i.RGB5_A1)}return(q===i.R16F||q===i.R32F||q===i.RG16F||q===i.RG32F||q===i.RGBA16F||q===i.RGBA32F)&&t.get("EXT_color_buffer_float"),q}function b(A,v){let L;return A?v===null||v===gn||v===cs?L=i.DEPTH24_STENCIL8:v===un?L=i.DEPTH32F_STENCIL8:v===ls&&(L=i.DEPTH24_STENCIL8,Lt("DepthTexture: 16 bit depth attachment is not supported with stencil. Using 24-bit attachment.")):v===null||v===gn||v===cs?L=i.DEPTH_COMPONENT24:v===un?L=i.DEPTH_COMPONENT32F:v===ls&&(L=i.DEPTH_COMPONENT16),L}function w(A,v){return m(A)===!0||A.isFramebufferTexture&&A.minFilter!==Re&&A.minFilter!==Ne?Math.log2(Math.max(v.width,v.height))+1:A.mipmaps!==void 0&&A.mipmaps.length>0?A.mipmaps.length:A.isCompressedTexture&&Array.isArray(A.image)?v.mipmaps.length:1}function E(A){const v=A.target;v.removeEventListener("dispose",E),_(v),v.isVideoTexture&&h.delete(v)}function C(A){const v=A.target;v.removeEventListener("dispose",C),O(v)}function _(A){const v=n.get(A);if(v.__webglInit===void 0)return;const L=A.source,Y=u.get(L);if(Y){const K=Y[v.__cacheKey];K.usedTimes--,K.usedTimes===0&&S(A),Object.keys(Y).length===0&&u.delete(L)}n.remove(A)}function S(A){const v=n.get(A);i.deleteTexture(v.__webglTexture);const L=A.source,Y=u.get(L);delete Y[v.__cacheKey],a.memory.textures--}function O(A){const v=n.get(A);if(A.depthTexture&&(A.depthTexture.dispose(),n.remove(A.depthTexture)),A.isWebGLCubeRenderTarget)for(let Y=0;Y<6;Y++){if(Array.isArray(v.__webglFramebuffer[Y]))for(let K=0;K<v.__webglFramebuffer[Y].length;K++)i.deleteFramebuffer(v.__webglFramebuffer[Y][K]);else i.deleteFramebuffer(v.__webglFramebuffer[Y]);v.__webglDepthbuffer&&i.deleteRenderbuffer(v.__webglDepthbuffer[Y])}else{if(Array.isArray(v.__webglFramebuffer))for(let Y=0;Y<v.__webglFramebuffer.length;Y++)i.deleteFramebuffer(v.__webglFramebuffer[Y]);else i.deleteFramebuffer(v.__webglFramebuffer);if(v.__webglDepthbuffer&&i.deleteRenderbuffer(v.__webglDepthbuffer),v.__webglMultisampledFramebuffer&&i.deleteFramebuffer(v.__webglMultisampledFramebuffer),v.__webglColorRenderbuffer)for(let Y=0;Y<v.__webglColorRenderbuffer.length;Y++)v.__webglColorRenderbuffer[Y]&&i.deleteRenderbuffer(v.__webglColorRenderbuffer[Y]);v.__webglDepthRenderbuffer&&i.deleteRenderbuffer(v.__webglDepthRenderbuffer)}const L=A.textures;for(let Y=0,K=L.length;Y<K;Y++){const q=n.get(L[Y]);q.__webglTexture&&(i.deleteTexture(q.__webglTexture),a.memory.textures--),n.remove(L[Y])}n.remove(A)}let R=0;function U(){R=0}function F(){const A=R;return A>=s.maxTextures&&Lt("WebGLTextures: Trying to use "+A+" texture units while this GPU supports only "+s.maxTextures),R+=1,A}function H(A){const v=[];return v.push(A.wrapS),v.push(A.wrapT),v.push(A.wrapR||0),v.push(A.magFilter),v.push(A.minFilter),v.push(A.anisotropy),v.push(A.internalFormat),v.push(A.format),v.push(A.type),v.push(A.generateMipmaps),v.push(A.premultiplyAlpha),v.push(A.flipY),v.push(A.unpackAlignment),v.push(A.colorSpace),v.join()}function B(A,v){const L=n.get(A);if(A.isVideoTexture&&Zt(A),A.isRenderTargetTexture===!1&&A.isExternalTexture!==!0&&A.version>0&&L.__version!==A.version){const Y=A.image;if(Y===null)Lt("WebGLRenderer: Texture marked for update but no image data found.");else if(Y.complete===!1)Lt("WebGLRenderer: Texture marked for update but image is incomplete");else{$(L,A,v);return}}else A.isExternalTexture&&(L.__webglTexture=A.sourceTexture?A.sourceTexture:null);e.bindTexture(i.TEXTURE_2D,L.__webglTexture,i.TEXTURE0+v)}function k(A,v){const L=n.get(A);if(A.isRenderTargetTexture===!1&&A.version>0&&L.__version!==A.version){$(L,A,v);return}else A.isExternalTexture&&(L.__webglTexture=A.sourceTexture?A.sourceTexture:null);e.bindTexture(i.TEXTURE_2D_ARRAY,L.__webglTexture,i.TEXTURE0+v)}function G(A,v){const L=n.get(A);if(A.isRenderTargetTexture===!1&&A.version>0&&L.__version!==A.version){$(L,A,v);return}e.bindTexture(i.TEXTURE_3D,L.__webglTexture,i.TEXTURE0+v)}function Q(A,v){const L=n.get(A);if(A.isCubeDepthTexture!==!0&&A.version>0&&L.__version!==A.version){nt(L,A,v);return}e.bindTexture(i.TEXTURE_CUBE_MAP,L.__webglTexture,i.TEXTURE0+v)}const Z={[wa]:i.REPEAT,[wn]:i.CLAMP_TO_EDGE,[Ca]:i.MIRRORED_REPEAT},ht={[Re]:i.NEAREST,[Gu]:i.NEAREST_MIPMAP_NEAREST,[As]:i.NEAREST_MIPMAP_LINEAR,[Ne]:i.LINEAR,[Cr]:i.LINEAR_MIPMAP_NEAREST,[li]:i.LINEAR_MIPMAP_LINEAR},mt={[Wu]:i.NEVER,[Ku]:i.ALWAYS,[Xu]:i.LESS,[Eo]:i.LEQUAL,[qu]:i.EQUAL,[To]:i.GEQUAL,[Yu]:i.GREATER,[$u]:i.NOTEQUAL};function dt(A,v){if(v.type===un&&t.has("OES_texture_float_linear")===!1&&(v.magFilter===Ne||v.magFilter===Cr||v.magFilter===As||v.magFilter===li||v.minFilter===Ne||v.minFilter===Cr||v.minFilter===As||v.minFilter===li)&&Lt("WebGLRenderer: Unable to use linear filtering with floating point textures. OES_texture_float_linear not supported on this device."),i.texParameteri(A,i.TEXTURE_WRAP_S,Z[v.wrapS]),i.texParameteri(A,i.TEXTURE_WRAP_T,Z[v.wrapT]),(A===i.TEXTURE_3D||A===i.TEXTURE_2D_ARRAY)&&i.texParameteri(A,i.TEXTURE_WRAP_R,Z[v.wrapR]),i.texParameteri(A,i.TEXTURE_MAG_FILTER,ht[v.magFilter]),i.texParameteri(A,i.TEXTURE_MIN_FILTER,ht[v.minFilter]),v.compareFunction&&(i.texParameteri(A,i.TEXTURE_COMPARE_MODE,i.COMPARE_REF_TO_TEXTURE),i.texParameteri(A,i.TEXTURE_COMPARE_FUNC,mt[v.compareFunction])),t.has("EXT_texture_filter_anisotropic")===!0){if(v.magFilter===Re||v.minFilter!==As&&v.minFilter!==li||v.type===un&&t.has("OES_texture_float_linear")===!1)return;if(v.anisotropy>1||n.get(v).__currentAnisotropy){const L=t.get("EXT_texture_filter_anisotropic");i.texParameterf(A,L.TEXTURE_MAX_ANISOTROPY_EXT,Math.min(v.anisotropy,s.getMaxAnisotropy())),n.get(v).__currentAnisotropy=v.anisotropy}}}function Ft(A,v){let L=!1;A.__webglInit===void 0&&(A.__webglInit=!0,v.addEventListener("dispose",E));const Y=v.source;let K=u.get(Y);K===void 0&&(K={},u.set(Y,K));const q=H(v);if(q!==A.__cacheKey){K[q]===void 0&&(K[q]={texture:i.createTexture(),usedTimes:0},a.memory.textures++,L=!0),K[q].usedTimes++;const gt=K[A.__cacheKey];gt!==void 0&&(K[A.__cacheKey].usedTimes--,gt.usedTimes===0&&S(v)),A.__cacheKey=q,A.__webglTexture=K[q].texture}return L}function ce(A,v,L){return Math.floor(Math.floor(A/L)/v)}function le(A,v,L,Y){const q=A.updateRanges;if(q.length===0)e.texSubImage2D(i.TEXTURE_2D,0,0,0,v.width,v.height,L,Y,v.data);else{q.sort((j,tt)=>j.start-tt.start);let gt=0;for(let j=1;j<q.length;j++){const tt=q[gt],_t=q[j],xt=tt.start+tt.count,ut=ce(_t.start,v.width,4),zt=ce(tt.start,v.width,4);_t.start<=xt+1&&ut===zt&&ce(_t.start+_t.count-1,v.width,4)===ut?tt.count=Math.max(tt.count,_t.start+_t.count-tt.start):(++gt,q[gt]=_t)}q.length=gt+1;const it=i.getParameter(i.UNPACK_ROW_LENGTH),Tt=i.getParameter(i.UNPACK_SKIP_PIXELS),Ct=i.getParameter(i.UNPACK_SKIP_ROWS);i.pixelStorei(i.UNPACK_ROW_LENGTH,v.width);for(let j=0,tt=q.length;j<tt;j++){const _t=q[j],xt=Math.floor(_t.start/4),ut=Math.ceil(_t.count/4),zt=xt%v.width,I=Math.floor(xt/v.width),st=ut,et=1;i.pixelStorei(i.UNPACK_SKIP_PIXELS,zt),i.pixelStorei(i.UNPACK_SKIP_ROWS,I),e.texSubImage2D(i.TEXTURE_2D,0,zt,I,st,et,L,Y,v.data)}A.clearUpdateRanges(),i.pixelStorei(i.UNPACK_ROW_LENGTH,it),i.pixelStorei(i.UNPACK_SKIP_PIXELS,Tt),i.pixelStorei(i.UNPACK_SKIP_ROWS,Ct)}}function $(A,v,L){let Y=i.TEXTURE_2D;(v.isDataArrayTexture||v.isCompressedArrayTexture)&&(Y=i.TEXTURE_2D_ARRAY),v.isData3DTexture&&(Y=i.TEXTURE_3D);const K=Ft(A,v),q=v.source;e.bindTexture(Y,A.__webglTexture,i.TEXTURE0+L);const gt=n.get(q);if(q.version!==gt.__version||K===!0){e.activeTexture(i.TEXTURE0+L);const it=qt.getPrimaries(qt.workingColorSpace),Tt=v.colorSpace===Vn?null:qt.getPrimaries(v.colorSpace),Ct=v.colorSpace===Vn||it===Tt?i.NONE:i.BROWSER_DEFAULT_WEBGL;i.pixelStorei(i.UNPACK_FLIP_Y_WEBGL,v.flipY),i.pixelStorei(i.UNPACK_PREMULTIPLY_ALPHA_WEBGL,v.premultiplyAlpha),i.pixelStorei(i.UNPACK_ALIGNMENT,v.unpackAlignment),i.pixelStorei(i.UNPACK_COLORSPACE_CONVERSION_WEBGL,Ct);let j=x(v.image,!1,s.maxTextureSize);j=re(v,j);const tt=r.convert(v.format,v.colorSpace),_t=r.convert(v.type);let xt=T(v.internalFormat,tt,_t,v.colorSpace,v.isVideoTexture);dt(Y,v);let ut;const zt=v.mipmaps,I=v.isVideoTexture!==!0,st=gt.__version===void 0||K===!0,et=q.dataReady,pt=w(v,j);if(v.isDepthTexture)xt=b(v.format===ci,v.type),st&&(I?e.texStorage2D(i.TEXTURE_2D,1,xt,j.width,j.height):e.texImage2D(i.TEXTURE_2D,0,xt,j.width,j.height,0,tt,_t,null));else if(v.isDataTexture)if(zt.length>0){I&&st&&e.texStorage2D(i.TEXTURE_2D,pt,xt,zt[0].width,zt[0].height);for(let J=0,X=zt.length;J<X;J++)ut=zt[J],I?et&&e.texSubImage2D(i.TEXTURE_2D,J,0,0,ut.width,ut.height,tt,_t,ut.data):e.texImage2D(i.TEXTURE_2D,J,xt,ut.width,ut.height,0,tt,_t,ut.data);v.generateMipmaps=!1}else I?(st&&e.texStorage2D(i.TEXTURE_2D,pt,xt,j.width,j.height),et&&le(v,j,tt,_t)):e.texImage2D(i.TEXTURE_2D,0,xt,j.width,j.height,0,tt,_t,j.data);else if(v.isCompressedTexture)if(v.isCompressedArrayTexture){I&&st&&e.texStorage3D(i.TEXTURE_2D_ARRAY,pt,xt,zt[0].width,zt[0].height,j.depth);for(let J=0,X=zt.length;J<X;J++)if(ut=zt[J],v.format!==rn)if(tt!==null)if(I){if(et)if(v.layerUpdates.size>0){const vt=Gl(ut.width,ut.height,v.format,v.type);for(const It of v.layerUpdates){const ae=ut.data.subarray(It*vt/ut.data.BYTES_PER_ELEMENT,(It+1)*vt/ut.data.BYTES_PER_ELEMENT);e.compressedTexSubImage3D(i.TEXTURE_2D_ARRAY,J,0,0,It,ut.width,ut.height,1,tt,ae)}v.clearLayerUpdates()}else e.compressedTexSubImage3D(i.TEXTURE_2D_ARRAY,J,0,0,0,ut.width,ut.height,j.depth,tt,ut.data)}else e.compressedTexImage3D(i.TEXTURE_2D_ARRAY,J,xt,ut.width,ut.height,j.depth,0,ut.data,0,0);else Lt("WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()");else I?et&&e.texSubImage3D(i.TEXTURE_2D_ARRAY,J,0,0,0,ut.width,ut.height,j.depth,tt,_t,ut.data):e.texImage3D(i.TEXTURE_2D_ARRAY,J,xt,ut.width,ut.height,j.depth,0,tt,_t,ut.data)}else{I&&st&&e.texStorage2D(i.TEXTURE_2D,pt,xt,zt[0].width,zt[0].height);for(let J=0,X=zt.length;J<X;J++)ut=zt[J],v.format!==rn?tt!==null?I?et&&e.compressedTexSubImage2D(i.TEXTURE_2D,J,0,0,ut.width,ut.height,tt,ut.data):e.compressedTexImage2D(i.TEXTURE_2D,J,xt,ut.width,ut.height,0,ut.data):Lt("WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()"):I?et&&e.texSubImage2D(i.TEXTURE_2D,J,0,0,ut.width,ut.height,tt,_t,ut.data):e.texImage2D(i.TEXTURE_2D,J,xt,ut.width,ut.height,0,tt,_t,ut.data)}else if(v.isDataArrayTexture)if(I){if(st&&e.texStorage3D(i.TEXTURE_2D_ARRAY,pt,xt,j.width,j.height,j.depth),et)if(v.layerUpdates.size>0){const J=Gl(j.width,j.height,v.format,v.type);for(const X of v.layerUpdates){const vt=j.data.subarray(X*J/j.data.BYTES_PER_ELEMENT,(X+1)*J/j.data.BYTES_PER_ELEMENT);e.texSubImage3D(i.TEXTURE_2D_ARRAY,0,0,0,X,j.width,j.height,1,tt,_t,vt)}v.clearLayerUpdates()}else e.texSubImage3D(i.TEXTURE_2D_ARRAY,0,0,0,0,j.width,j.height,j.depth,tt,_t,j.data)}else e.texImage3D(i.TEXTURE_2D_ARRAY,0,xt,j.width,j.height,j.depth,0,tt,_t,j.data);else if(v.isData3DTexture)I?(st&&e.texStorage3D(i.TEXTURE_3D,pt,xt,j.width,j.height,j.depth),et&&e.texSubImage3D(i.TEXTURE_3D,0,0,0,0,j.width,j.height,j.depth,tt,_t,j.data)):e.texImage3D(i.TEXTURE_3D,0,xt,j.width,j.height,j.depth,0,tt,_t,j.data);else if(v.isFramebufferTexture){if(st)if(I)e.texStorage2D(i.TEXTURE_2D,pt,xt,j.width,j.height);else{let J=j.width,X=j.height;for(let vt=0;vt<pt;vt++)e.texImage2D(i.TEXTURE_2D,vt,xt,J,X,0,tt,_t,null),J>>=1,X>>=1}}else if(zt.length>0){if(I&&st){const J=St(zt[0]);e.texStorage2D(i.TEXTURE_2D,pt,xt,J.width,J.height)}for(let J=0,X=zt.length;J<X;J++)ut=zt[J],I?et&&e.texSubImage2D(i.TEXTURE_2D,J,0,0,tt,_t,ut):e.texImage2D(i.TEXTURE_2D,J,xt,tt,_t,ut);v.generateMipmaps=!1}else if(I){if(st){const J=St(j);e.texStorage2D(i.TEXTURE_2D,pt,xt,J.width,J.height)}et&&e.texSubImage2D(i.TEXTURE_2D,0,0,0,tt,_t,j)}else e.texImage2D(i.TEXTURE_2D,0,xt,tt,_t,j);m(v)&&f(Y),gt.__version=q.version,v.onUpdate&&v.onUpdate(v)}A.__version=v.version}function nt(A,v,L){if(v.image.length!==6)return;const Y=Ft(A,v),K=v.source;e.bindTexture(i.TEXTURE_CUBE_MAP,A.__webglTexture,i.TEXTURE0+L);const q=n.get(K);if(K.version!==q.__version||Y===!0){e.activeTexture(i.TEXTURE0+L);const gt=qt.getPrimaries(qt.workingColorSpace),it=v.colorSpace===Vn?null:qt.getPrimaries(v.colorSpace),Tt=v.colorSpace===Vn||gt===it?i.NONE:i.BROWSER_DEFAULT_WEBGL;i.pixelStorei(i.UNPACK_FLIP_Y_WEBGL,v.flipY),i.pixelStorei(i.UNPACK_PREMULTIPLY_ALPHA_WEBGL,v.premultiplyAlpha),i.pixelStorei(i.UNPACK_ALIGNMENT,v.unpackAlignment),i.pixelStorei(i.UNPACK_COLORSPACE_CONVERSION_WEBGL,Tt);const Ct=v.isCompressedTexture||v.image[0].isCompressedTexture,j=v.image[0]&&v.image[0].isDataTexture,tt=[];for(let X=0;X<6;X++)!Ct&&!j?tt[X]=x(v.image[X],!0,s.maxCubemapSize):tt[X]=j?v.image[X].image:v.image[X],tt[X]=re(v,tt[X]);const _t=tt[0],xt=r.convert(v.format,v.colorSpace),ut=r.convert(v.type),zt=T(v.internalFormat,xt,ut,v.colorSpace),I=v.isVideoTexture!==!0,st=q.__version===void 0||Y===!0,et=K.dataReady;let pt=w(v,_t);dt(i.TEXTURE_CUBE_MAP,v);let J;if(Ct){I&&st&&e.texStorage2D(i.TEXTURE_CUBE_MAP,pt,zt,_t.width,_t.height);for(let X=0;X<6;X++){J=tt[X].mipmaps;for(let vt=0;vt<J.length;vt++){const It=J[vt];v.format!==rn?xt!==null?I?et&&e.compressedTexSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+X,vt,0,0,It.width,It.height,xt,It.data):e.compressedTexImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+X,vt,zt,It.width,It.height,0,It.data):Lt("WebGLRenderer: Attempt to load unsupported compressed texture format in .setTextureCube()"):I?et&&e.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+X,vt,0,0,It.width,It.height,xt,ut,It.data):e.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+X,vt,zt,It.width,It.height,0,xt,ut,It.data)}}}else{if(J=v.mipmaps,I&&st){J.length>0&&pt++;const X=St(tt[0]);e.texStorage2D(i.TEXTURE_CUBE_MAP,pt,zt,X.width,X.height)}for(let X=0;X<6;X++)if(j){I?et&&e.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+X,0,0,0,tt[X].width,tt[X].height,xt,ut,tt[X].data):e.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+X,0,zt,tt[X].width,tt[X].height,0,xt,ut,tt[X].data);for(let vt=0;vt<J.length;vt++){const ae=J[vt].image[X].image;I?et&&e.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+X,vt+1,0,0,ae.width,ae.height,xt,ut,ae.data):e.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+X,vt+1,zt,ae.width,ae.height,0,xt,ut,ae.data)}}else{I?et&&e.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+X,0,0,0,xt,ut,tt[X]):e.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+X,0,zt,xt,ut,tt[X]);for(let vt=0;vt<J.length;vt++){const It=J[vt];I?et&&e.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+X,vt+1,0,0,xt,ut,It.image[X]):e.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+X,vt+1,zt,xt,ut,It.image[X])}}}m(v)&&f(i.TEXTURE_CUBE_MAP),q.__version=K.version,v.onUpdate&&v.onUpdate(v)}A.__version=v.version}function rt(A,v,L,Y,K,q){const gt=r.convert(L.format,L.colorSpace),it=r.convert(L.type),Tt=T(L.internalFormat,gt,it,L.colorSpace),Ct=n.get(v),j=n.get(L);if(j.__renderTarget=v,!Ct.__hasExternalTextures){const tt=Math.max(1,v.width>>q),_t=Math.max(1,v.height>>q);K===i.TEXTURE_3D||K===i.TEXTURE_2D_ARRAY?e.texImage3D(K,q,Tt,tt,_t,v.depth,0,gt,it,null):e.texImage2D(K,q,Tt,tt,_t,0,gt,it,null)}e.bindFramebuffer(i.FRAMEBUFFER,A),Me(v)?o.framebufferTexture2DMultisampleEXT(i.FRAMEBUFFER,Y,K,j.__webglTexture,0,P(v)):(K===i.TEXTURE_2D||K>=i.TEXTURE_CUBE_MAP_POSITIVE_X&&K<=i.TEXTURE_CUBE_MAP_NEGATIVE_Z)&&i.framebufferTexture2D(i.FRAMEBUFFER,Y,K,j.__webglTexture,q),e.bindFramebuffer(i.FRAMEBUFFER,null)}function Ut(A,v,L){if(i.bindRenderbuffer(i.RENDERBUFFER,A),v.depthBuffer){const Y=v.depthTexture,K=Y&&Y.isDepthTexture?Y.type:null,q=b(v.stencilBuffer,K),gt=v.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT;Me(v)?o.renderbufferStorageMultisampleEXT(i.RENDERBUFFER,P(v),q,v.width,v.height):L?i.renderbufferStorageMultisample(i.RENDERBUFFER,P(v),q,v.width,v.height):i.renderbufferStorage(i.RENDERBUFFER,q,v.width,v.height),i.framebufferRenderbuffer(i.FRAMEBUFFER,gt,i.RENDERBUFFER,A)}else{const Y=v.textures;for(let K=0;K<Y.length;K++){const q=Y[K],gt=r.convert(q.format,q.colorSpace),it=r.convert(q.type),Tt=T(q.internalFormat,gt,it,q.colorSpace);Me(v)?o.renderbufferStorageMultisampleEXT(i.RENDERBUFFER,P(v),Tt,v.width,v.height):L?i.renderbufferStorageMultisample(i.RENDERBUFFER,P(v),Tt,v.width,v.height):i.renderbufferStorage(i.RENDERBUFFER,Tt,v.width,v.height)}}i.bindRenderbuffer(i.RENDERBUFFER,null)}function wt(A,v,L){const Y=v.isWebGLCubeRenderTarget===!0;if(e.bindFramebuffer(i.FRAMEBUFFER,A),!(v.depthTexture&&v.depthTexture.isDepthTexture))throw new Error("renderTarget.depthTexture must be an instance of THREE.DepthTexture");const K=n.get(v.depthTexture);if(K.__renderTarget=v,(!K.__webglTexture||v.depthTexture.image.width!==v.width||v.depthTexture.image.height!==v.height)&&(v.depthTexture.image.width=v.width,v.depthTexture.image.height=v.height,v.depthTexture.needsUpdate=!0),Y){if(K.__webglInit===void 0&&(K.__webglInit=!0,v.depthTexture.addEventListener("dispose",E)),K.__webglTexture===void 0){K.__webglTexture=i.createTexture(),e.bindTexture(i.TEXTURE_CUBE_MAP,K.__webglTexture),dt(i.TEXTURE_CUBE_MAP,v.depthTexture);const Ct=r.convert(v.depthTexture.format),j=r.convert(v.depthTexture.type);let tt;v.depthTexture.format===Ln?tt=i.DEPTH_COMPONENT24:v.depthTexture.format===ci&&(tt=i.DEPTH24_STENCIL8);for(let _t=0;_t<6;_t++)i.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+_t,0,tt,v.width,v.height,0,Ct,j,null)}}else B(v.depthTexture,0);const q=K.__webglTexture,gt=P(v),it=Y?i.TEXTURE_CUBE_MAP_POSITIVE_X+L:i.TEXTURE_2D,Tt=v.depthTexture.format===ci?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT;if(v.depthTexture.format===Ln)Me(v)?o.framebufferTexture2DMultisampleEXT(i.FRAMEBUFFER,Tt,it,q,0,gt):i.framebufferTexture2D(i.FRAMEBUFFER,Tt,it,q,0);else if(v.depthTexture.format===ci)Me(v)?o.framebufferTexture2DMultisampleEXT(i.FRAMEBUFFER,Tt,it,q,0,gt):i.framebufferTexture2D(i.FRAMEBUFFER,Tt,it,q,0);else throw new Error("Unknown depthTexture format")}function Pt(A){const v=n.get(A),L=A.isWebGLCubeRenderTarget===!0;if(v.__boundDepthTexture!==A.depthTexture){const Y=A.depthTexture;if(v.__depthDisposeCallback&&v.__depthDisposeCallback(),Y){const K=()=>{delete v.__boundDepthTexture,delete v.__depthDisposeCallback,Y.removeEventListener("dispose",K)};Y.addEventListener("dispose",K),v.__depthDisposeCallback=K}v.__boundDepthTexture=Y}if(A.depthTexture&&!v.__autoAllocateDepthBuffer)if(L)for(let Y=0;Y<6;Y++)wt(v.__webglFramebuffer[Y],A,Y);else{const Y=A.texture.mipmaps;Y&&Y.length>0?wt(v.__webglFramebuffer[0],A,0):wt(v.__webglFramebuffer,A,0)}else if(L){v.__webglDepthbuffer=[];for(let Y=0;Y<6;Y++)if(e.bindFramebuffer(i.FRAMEBUFFER,v.__webglFramebuffer[Y]),v.__webglDepthbuffer[Y]===void 0)v.__webglDepthbuffer[Y]=i.createRenderbuffer(),Ut(v.__webglDepthbuffer[Y],A,!1);else{const K=A.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT,q=v.__webglDepthbuffer[Y];i.bindRenderbuffer(i.RENDERBUFFER,q),i.framebufferRenderbuffer(i.FRAMEBUFFER,K,i.RENDERBUFFER,q)}}else{const Y=A.texture.mipmaps;if(Y&&Y.length>0?e.bindFramebuffer(i.FRAMEBUFFER,v.__webglFramebuffer[0]):e.bindFramebuffer(i.FRAMEBUFFER,v.__webglFramebuffer),v.__webglDepthbuffer===void 0)v.__webglDepthbuffer=i.createRenderbuffer(),Ut(v.__webglDepthbuffer,A,!1);else{const K=A.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT,q=v.__webglDepthbuffer;i.bindRenderbuffer(i.RENDERBUFFER,q),i.framebufferRenderbuffer(i.FRAMEBUFFER,K,i.RENDERBUFFER,q)}}e.bindFramebuffer(i.FRAMEBUFFER,null)}function Te(A,v,L){const Y=n.get(A);v!==void 0&&rt(Y.__webglFramebuffer,A,A.texture,i.COLOR_ATTACHMENT0,i.TEXTURE_2D,0),L!==void 0&&Pt(A)}function Wt(A){const v=A.texture,L=n.get(A),Y=n.get(v);A.addEventListener("dispose",C);const K=A.textures,q=A.isWebGLCubeRenderTarget===!0,gt=K.length>1;if(gt||(Y.__webglTexture===void 0&&(Y.__webglTexture=i.createTexture()),Y.__version=v.version,a.memory.textures++),q){L.__webglFramebuffer=[];for(let it=0;it<6;it++)if(v.mipmaps&&v.mipmaps.length>0){L.__webglFramebuffer[it]=[];for(let Tt=0;Tt<v.mipmaps.length;Tt++)L.__webglFramebuffer[it][Tt]=i.createFramebuffer()}else L.__webglFramebuffer[it]=i.createFramebuffer()}else{if(v.mipmaps&&v.mipmaps.length>0){L.__webglFramebuffer=[];for(let it=0;it<v.mipmaps.length;it++)L.__webglFramebuffer[it]=i.createFramebuffer()}else L.__webglFramebuffer=i.createFramebuffer();if(gt)for(let it=0,Tt=K.length;it<Tt;it++){const Ct=n.get(K[it]);Ct.__webglTexture===void 0&&(Ct.__webglTexture=i.createTexture(),a.memory.textures++)}if(A.samples>0&&Me(A)===!1){L.__webglMultisampledFramebuffer=i.createFramebuffer(),L.__webglColorRenderbuffer=[],e.bindFramebuffer(i.FRAMEBUFFER,L.__webglMultisampledFramebuffer);for(let it=0;it<K.length;it++){const Tt=K[it];L.__webglColorRenderbuffer[it]=i.createRenderbuffer(),i.bindRenderbuffer(i.RENDERBUFFER,L.__webglColorRenderbuffer[it]);const Ct=r.convert(Tt.format,Tt.colorSpace),j=r.convert(Tt.type),tt=T(Tt.internalFormat,Ct,j,Tt.colorSpace,A.isXRRenderTarget===!0),_t=P(A);i.renderbufferStorageMultisample(i.RENDERBUFFER,_t,tt,A.width,A.height),i.framebufferRenderbuffer(i.FRAMEBUFFER,i.COLOR_ATTACHMENT0+it,i.RENDERBUFFER,L.__webglColorRenderbuffer[it])}i.bindRenderbuffer(i.RENDERBUFFER,null),A.depthBuffer&&(L.__webglDepthRenderbuffer=i.createRenderbuffer(),Ut(L.__webglDepthRenderbuffer,A,!0)),e.bindFramebuffer(i.FRAMEBUFFER,null)}}if(q){e.bindTexture(i.TEXTURE_CUBE_MAP,Y.__webglTexture),dt(i.TEXTURE_CUBE_MAP,v);for(let it=0;it<6;it++)if(v.mipmaps&&v.mipmaps.length>0)for(let Tt=0;Tt<v.mipmaps.length;Tt++)rt(L.__webglFramebuffer[it][Tt],A,v,i.COLOR_ATTACHMENT0,i.TEXTURE_CUBE_MAP_POSITIVE_X+it,Tt);else rt(L.__webglFramebuffer[it],A,v,i.COLOR_ATTACHMENT0,i.TEXTURE_CUBE_MAP_POSITIVE_X+it,0);m(v)&&f(i.TEXTURE_CUBE_MAP),e.unbindTexture()}else if(gt){for(let it=0,Tt=K.length;it<Tt;it++){const Ct=K[it],j=n.get(Ct);let tt=i.TEXTURE_2D;(A.isWebGL3DRenderTarget||A.isWebGLArrayRenderTarget)&&(tt=A.isWebGL3DRenderTarget?i.TEXTURE_3D:i.TEXTURE_2D_ARRAY),e.bindTexture(tt,j.__webglTexture),dt(tt,Ct),rt(L.__webglFramebuffer,A,Ct,i.COLOR_ATTACHMENT0+it,tt,0),m(Ct)&&f(tt)}e.unbindTexture()}else{let it=i.TEXTURE_2D;if((A.isWebGL3DRenderTarget||A.isWebGLArrayRenderTarget)&&(it=A.isWebGL3DRenderTarget?i.TEXTURE_3D:i.TEXTURE_2D_ARRAY),e.bindTexture(it,Y.__webglTexture),dt(it,v),v.mipmaps&&v.mipmaps.length>0)for(let Tt=0;Tt<v.mipmaps.length;Tt++)rt(L.__webglFramebuffer[Tt],A,v,i.COLOR_ATTACHMENT0,it,Tt);else rt(L.__webglFramebuffer,A,v,i.COLOR_ATTACHMENT0,it,0);m(v)&&f(it),e.unbindTexture()}A.depthBuffer&&Pt(A)}function Jt(A){const v=A.textures;for(let L=0,Y=v.length;L<Y;L++){const K=v[L];if(m(K)){const q=y(A),gt=n.get(K).__webglTexture;e.bindTexture(q,gt),f(q),e.unbindTexture()}}}const ie=[],Bt=[];function ge(A){if(A.samples>0){if(Me(A)===!1){const v=A.textures,L=A.width,Y=A.height;let K=i.COLOR_BUFFER_BIT;const q=A.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT,gt=n.get(A),it=v.length>1;if(it)for(let Ct=0;Ct<v.length;Ct++)e.bindFramebuffer(i.FRAMEBUFFER,gt.__webglMultisampledFramebuffer),i.framebufferRenderbuffer(i.FRAMEBUFFER,i.COLOR_ATTACHMENT0+Ct,i.RENDERBUFFER,null),e.bindFramebuffer(i.FRAMEBUFFER,gt.__webglFramebuffer),i.framebufferTexture2D(i.DRAW_FRAMEBUFFER,i.COLOR_ATTACHMENT0+Ct,i.TEXTURE_2D,null,0);e.bindFramebuffer(i.READ_FRAMEBUFFER,gt.__webglMultisampledFramebuffer);const Tt=A.texture.mipmaps;Tt&&Tt.length>0?e.bindFramebuffer(i.DRAW_FRAMEBUFFER,gt.__webglFramebuffer[0]):e.bindFramebuffer(i.DRAW_FRAMEBUFFER,gt.__webglFramebuffer);for(let Ct=0;Ct<v.length;Ct++){if(A.resolveDepthBuffer&&(A.depthBuffer&&(K|=i.DEPTH_BUFFER_BIT),A.stencilBuffer&&A.resolveStencilBuffer&&(K|=i.STENCIL_BUFFER_BIT)),it){i.framebufferRenderbuffer(i.READ_FRAMEBUFFER,i.COLOR_ATTACHMENT0,i.RENDERBUFFER,gt.__webglColorRenderbuffer[Ct]);const j=n.get(v[Ct]).__webglTexture;i.framebufferTexture2D(i.DRAW_FRAMEBUFFER,i.COLOR_ATTACHMENT0,i.TEXTURE_2D,j,0)}i.blitFramebuffer(0,0,L,Y,0,0,L,Y,K,i.NEAREST),c===!0&&(ie.length=0,Bt.length=0,ie.push(i.COLOR_ATTACHMENT0+Ct),A.depthBuffer&&A.resolveDepthBuffer===!1&&(ie.push(q),Bt.push(q),i.invalidateFramebuffer(i.DRAW_FRAMEBUFFER,Bt)),i.invalidateFramebuffer(i.READ_FRAMEBUFFER,ie))}if(e.bindFramebuffer(i.READ_FRAMEBUFFER,null),e.bindFramebuffer(i.DRAW_FRAMEBUFFER,null),it)for(let Ct=0;Ct<v.length;Ct++){e.bindFramebuffer(i.FRAMEBUFFER,gt.__webglMultisampledFramebuffer),i.framebufferRenderbuffer(i.FRAMEBUFFER,i.COLOR_ATTACHMENT0+Ct,i.RENDERBUFFER,gt.__webglColorRenderbuffer[Ct]);const j=n.get(v[Ct]).__webglTexture;e.bindFramebuffer(i.FRAMEBUFFER,gt.__webglFramebuffer),i.framebufferTexture2D(i.DRAW_FRAMEBUFFER,i.COLOR_ATTACHMENT0+Ct,i.TEXTURE_2D,j,0)}e.bindFramebuffer(i.DRAW_FRAMEBUFFER,gt.__webglMultisampledFramebuffer)}else if(A.depthBuffer&&A.resolveDepthBuffer===!1&&c){const v=A.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT;i.invalidateFramebuffer(i.DRAW_FRAMEBUFFER,[v])}}}function P(A){return Math.min(s.maxSamples,A.samples)}function Me(A){const v=n.get(A);return A.samples>0&&t.has("WEBGL_multisampled_render_to_texture")===!0&&v.__useRenderToTexture!==!1}function Zt(A){const v=a.render.frame;h.get(A)!==v&&(h.set(A,v),A.update())}function re(A,v){const L=A.colorSpace,Y=A.format,K=A.type;return A.isCompressedTexture===!0||A.isVideoTexture===!0||L!==Hi&&L!==Vn&&(qt.getTransfer(L)===te?(Y!==rn||K!==$e)&&Lt("WebGLTextures: sRGB encoded textures have to use RGBAFormat and UnsignedByteType."):Xt("WebGLTextures: Unsupported texture color space:",L)),v}function St(A){return typeof HTMLImageElement<"u"&&A instanceof HTMLImageElement?(l.width=A.naturalWidth||A.width,l.height=A.naturalHeight||A.height):typeof VideoFrame<"u"&&A instanceof VideoFrame?(l.width=A.displayWidth,l.height=A.displayHeight):(l.width=A.width,l.height=A.height),l}this.allocateTextureUnit=F,this.resetTextureUnits=U,this.setTexture2D=B,this.setTexture2DArray=k,this.setTexture3D=G,this.setTextureCube=Q,this.rebindTextures=Te,this.setupRenderTarget=Wt,this.updateRenderTargetMipmap=Jt,this.updateMultisampleRenderTarget=ge,this.setupDepthRenderbuffer=Pt,this.setupFrameBufferTexture=rt,this.useMultisampledRTT=Me,this.isReversedDepthBuffer=function(){return e.buffers.depth.getReversed()}}function w0(i,t){function e(n,s=Vn){let r;const a=qt.getTransfer(s);if(n===$e)return i.UNSIGNED_BYTE;if(n===xo)return i.UNSIGNED_SHORT_4_4_4_4;if(n===Mo)return i.UNSIGNED_SHORT_5_5_5_1;if(n===qc)return i.UNSIGNED_INT_5_9_9_9_REV;if(n===Yc)return i.UNSIGNED_INT_10F_11F_11F_REV;if(n===Wc)return i.BYTE;if(n===Xc)return i.SHORT;if(n===ls)return i.UNSIGNED_SHORT;if(n===vo)return i.INT;if(n===gn)return i.UNSIGNED_INT;if(n===un)return i.FLOAT;if(n===In)return i.HALF_FLOAT;if(n===$c)return i.ALPHA;if(n===Kc)return i.RGB;if(n===rn)return i.RGBA;if(n===Ln)return i.DEPTH_COMPONENT;if(n===ci)return i.DEPTH_STENCIL;if(n===Zc)return i.RED;if(n===So)return i.RED_INTEGER;if(n===Vi)return i.RG;if(n===yo)return i.RG_INTEGER;if(n===bo)return i.RGBA_INTEGER;if(n===sr||n===rr||n===ar||n===or)if(a===te)if(r=t.get("WEBGL_compressed_texture_s3tc_srgb"),r!==null){if(n===sr)return r.COMPRESSED_SRGB_S3TC_DXT1_EXT;if(n===rr)return r.COMPRESSED_SRGB_ALPHA_S3TC_DXT1_EXT;if(n===ar)return r.COMPRESSED_SRGB_ALPHA_S3TC_DXT3_EXT;if(n===or)return r.COMPRESSED_SRGB_ALPHA_S3TC_DXT5_EXT}else return null;else if(r=t.get("WEBGL_compressed_texture_s3tc"),r!==null){if(n===sr)return r.COMPRESSED_RGB_S3TC_DXT1_EXT;if(n===rr)return r.COMPRESSED_RGBA_S3TC_DXT1_EXT;if(n===ar)return r.COMPRESSED_RGBA_S3TC_DXT3_EXT;if(n===or)return r.COMPRESSED_RGBA_S3TC_DXT5_EXT}else return null;if(n===Ra||n===Pa||n===Ia||n===La)if(r=t.get("WEBGL_compressed_texture_pvrtc"),r!==null){if(n===Ra)return r.COMPRESSED_RGB_PVRTC_4BPPV1_IMG;if(n===Pa)return r.COMPRESSED_RGB_PVRTC_2BPPV1_IMG;if(n===Ia)return r.COMPRESSED_RGBA_PVRTC_4BPPV1_IMG;if(n===La)return r.COMPRESSED_RGBA_PVRTC_2BPPV1_IMG}else return null;if(n===Da||n===Ua||n===Na||n===Fa||n===Oa||n===Ba||n===za)if(r=t.get("WEBGL_compressed_texture_etc"),r!==null){if(n===Da||n===Ua)return a===te?r.COMPRESSED_SRGB8_ETC2:r.COMPRESSED_RGB8_ETC2;if(n===Na)return a===te?r.COMPRESSED_SRGB8_ALPHA8_ETC2_EAC:r.COMPRESSED_RGBA8_ETC2_EAC;if(n===Fa)return r.COMPRESSED_R11_EAC;if(n===Oa)return r.COMPRESSED_SIGNED_R11_EAC;if(n===Ba)return r.COMPRESSED_RG11_EAC;if(n===za)return r.COMPRESSED_SIGNED_RG11_EAC}else return null;if(n===ka||n===Ga||n===Va||n===Ha||n===Wa||n===Xa||n===qa||n===Ya||n===$a||n===Ka||n===Za||n===ja||n===Ja||n===Qa)if(r=t.get("WEBGL_compressed_texture_astc"),r!==null){if(n===ka)return a===te?r.COMPRESSED_SRGB8_ALPHA8_ASTC_4x4_KHR:r.COMPRESSED_RGBA_ASTC_4x4_KHR;if(n===Ga)return a===te?r.COMPRESSED_SRGB8_ALPHA8_ASTC_5x4_KHR:r.COMPRESSED_RGBA_ASTC_5x4_KHR;if(n===Va)return a===te?r.COMPRESSED_SRGB8_ALPHA8_ASTC_5x5_KHR:r.COMPRESSED_RGBA_ASTC_5x5_KHR;if(n===Ha)return a===te?r.COMPRESSED_SRGB8_ALPHA8_ASTC_6x5_KHR:r.COMPRESSED_RGBA_ASTC_6x5_KHR;if(n===Wa)return a===te?r.COMPRESSED_SRGB8_ALPHA8_ASTC_6x6_KHR:r.COMPRESSED_RGBA_ASTC_6x6_KHR;if(n===Xa)return a===te?r.COMPRESSED_SRGB8_ALPHA8_ASTC_8x5_KHR:r.COMPRESSED_RGBA_ASTC_8x5_KHR;if(n===qa)return a===te?r.COMPRESSED_SRGB8_ALPHA8_ASTC_8x6_KHR:r.COMPRESSED_RGBA_ASTC_8x6_KHR;if(n===Ya)return a===te?r.COMPRESSED_SRGB8_ALPHA8_ASTC_8x8_KHR:r.COMPRESSED_RGBA_ASTC_8x8_KHR;if(n===$a)return a===te?r.COMPRESSED_SRGB8_ALPHA8_ASTC_10x5_KHR:r.COMPRESSED_RGBA_ASTC_10x5_KHR;if(n===Ka)return a===te?r.COMPRESSED_SRGB8_ALPHA8_ASTC_10x6_KHR:r.COMPRESSED_RGBA_ASTC_10x6_KHR;if(n===Za)return a===te?r.COMPRESSED_SRGB8_ALPHA8_ASTC_10x8_KHR:r.COMPRESSED_RGBA_ASTC_10x8_KHR;if(n===ja)return a===te?r.COMPRESSED_SRGB8_ALPHA8_ASTC_10x10_KHR:r.COMPRESSED_RGBA_ASTC_10x10_KHR;if(n===Ja)return a===te?r.COMPRESSED_SRGB8_ALPHA8_ASTC_12x10_KHR:r.COMPRESSED_RGBA_ASTC_12x10_KHR;if(n===Qa)return a===te?r.COMPRESSED_SRGB8_ALPHA8_ASTC_12x12_KHR:r.COMPRESSED_RGBA_ASTC_12x12_KHR}else return null;if(n===to||n===eo||n===no)if(r=t.get("EXT_texture_compression_bptc"),r!==null){if(n===to)return a===te?r.COMPRESSED_SRGB_ALPHA_BPTC_UNORM_EXT:r.COMPRESSED_RGBA_BPTC_UNORM_EXT;if(n===eo)return r.COMPRESSED_RGB_BPTC_SIGNED_FLOAT_EXT;if(n===no)return r.COMPRESSED_RGB_BPTC_UNSIGNED_FLOAT_EXT}else return null;if(n===io||n===so||n===ro||n===ao)if(r=t.get("EXT_texture_compression_rgtc"),r!==null){if(n===io)return r.COMPRESSED_RED_RGTC1_EXT;if(n===so)return r.COMPRESSED_SIGNED_RED_RGTC1_EXT;if(n===ro)return r.COMPRESSED_RED_GREEN_RGTC2_EXT;if(n===ao)return r.COMPRESSED_SIGNED_RED_GREEN_RGTC2_EXT}else return null;return n===cs?i.UNSIGNED_INT_24_8:i[n]!==void 0?i[n]:null}return{convert:e}}const C0=`
void main() {
...
void main() {
    ...
    `,i.appendChild(r)}),Gt("lb-reset").textContent=`resets in ${R_(T_())}`,xs("leaderboard");const e=i.querySelector(".lb-row.player");e&&setTimeout(()=>e.scrollIntoView({block:"center",behavior:"smooth"}),80)}function D_(){const i=Gt("ad-content"),t=Gt("ad-sub"),e=Gt("ad-progress-fill"),n=Gt("ad-skip"),s=Gt("ad-reward"),r=Gt("ad-actions"),a=Gt("ad-claim");i.innerHTML="AD<br>IN PROGRESS",t.textContent="hold tight — almost there",e.style.width="0%",s.classList.remove("show"),r.classList.remove("show"),n.textContent="SKIP in 5s",xs("ads-overlay");const o=5e3,c=performance.now();Hn&&clearInterval(Hn),Hn=setInterval(()=>{const l=performance.now()-c,h=Math.min(100,l/o*100);e.style.width=h+"%";const d=Math.max(0,Math.ceil((o-l)/1e3));if(n.textContent=d>0?`SKIP in ${d}s`:"",l>=o){clearInterval(Hn),Hn=null;const u=w_();i.innerHTML=u?"AD<br>COMPLETE":"TICKETS<br>AT MAX",t.textContent=u?"reward ready":"come back after spending tickets",u&&(s.textContent=`+${Do} 🎫`,s.classList.add("show")),r.classList.add("show"),a.textContent="OK"}},100)}function U_(){Hn&&(clearInterval(Hn),Hn=null),os()}function N_(){Gt("lobby-play").addEventListener("click",()=>{if(!S_()){uo();return}ur(),Pc(()=>{ma(),Cn.startMatch()})}),Gt("lobby-ads").addEventListener("click",()=>{Sh()&&(ur(),D_())}),Gt("lobby-leaderboard").addEventListener("click",()=>{ur(),L_()}),Gt("lb-close").addEventListener("click",()=>os()),Gt("lb-back").addEventListener("click",()=>os()),Gt("ad-claim").addEventListener("click",()=>U_()),Gt("endcard-lobby").addEventListener("click",()=>{Cn.exitToMenu(),os()}),Gt("endcard-replay").addEventListener("click",()=>{ma(),Cn.exitToMenu(),Pc(()=>{ma(),Cn.startMatch()})})}function F_(){window.__onMatchOver=i=>{I_(i)}}function O_(i){const t=m_();Cn=window.__GAME__||window.__game,Cn||console.error("[meta] startSoccer did not expose the game instance"),i&&i.classList.add("visible");const e=document.getElementById("game-canvas");return e&&e.classList.add("visible"),F_(),N_(),os(),t}const B_=document.getElementById("game-canvas"),ve=(...i)=>console.log("[Shell]",...i);async function bh(){ve("Booting...",`platform=${qn.getPlatform()}`,`native=${qn.isNativePlatform()}`);try{await il().initialize({appId:"Soccer 1x1",environment:"production"}),ve("[WildlifePlatform] initialized, version =",await il().getPlatformVersion())}catch(t){ve("[WildlifePlatform] initialize failed:",(t==null?void 0:t.message)??t)}lu(),fu();let i="1.0.0";if(qn.isNativePlatform()){try{const t=await Lc.getInfo();i=t.version||i,ve("Native app info:",JSON.stringify(t))}catch(t){ve("Could not get native app info:",t.message)}ve("Entering fullscreen mode..."),await Ko.hide(),await Ko.setOverlaysWebView({overlay:!0}),await Vh.hide(),ve("Fullscreen + splash hidden")}cu(i),ve("Shell version:",i,"| Content version:","1.0.0"),Nn.on("status",t=>{ve("OTA status:",t),Es(t)}),Nn.on("progress",t=>{ve("OTA progress:",t+"%"),ol(t)}),Nn.on("error",t=>ve("OTA error:",t));try{ve("Initializing OTA updater..."),await Nn.init(),ve("OTA updater initialized");const t=await Nn.getContentVersion();ve("Content version:",t),hu(t),ve("Checking for updates...");const e=await Nn.checkForUpdate();if(e){ve("Update manifest:",JSON.stringify(e)),Es("Downloading update..."),await Nn.downloadUpdate(e),Es("Applying update..."),ve("Applying update immediately..."),await Nn.applyNow();return}else ve("No update available");Es("Starting game..."),ol(100),ve("Launching game..."),await z_(300),O_(B_),ve("Lobby ready — hiding loader"),await du(),ve("Boot complete")}catch(t){console.error("[Shell] Startup error:",t),pu(t.message||"Failed to start the game.",()=>bh())}}function z_(i){return new Promise(t=>setTimeout(t,i))}bh();export{Ic as W};
