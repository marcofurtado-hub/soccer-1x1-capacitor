...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:Un,depthTest:!1,depthWrite:!1})}function Tg(i,t,e){const n=new Float32Array(mi),s=new N(0,1,0);return new bn({name:"SphericalGaussianBlur",defines:{n:mi,CUBEUV_TEXEL_WIDTH:1/t,CUBEUV_TEXEL_HEIGHT:1/e,CUBEUV_MAX_MIP:`${i}.0`},uniforms:{envMap:{value:null},samples:{value:1},weights:{value:n},latitudinal:{value:!1},dTheta:{value:0},mipInt:{value:0},poleAxis:{value:s}},vertexShader:Dr(),fragmentShader:`
		...
		`,blending:Un,depthTest:!1,depthWrite:!1})}function xc(){return new bn({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:Dr(),fragmentShader:`
		...
		`,blending:Un,depthTest:!1,depthWrite:!1})}function Mc(){return new bn({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:Dr(),fragmentShader:`
...
`)}const P0={[_h]:"Linear",[vh]:"Reinhard",[xh]:"Cineon",[Oo]:"ACESFilmic",[Sh]:"AgX",[yh]:"Neutral",[Mh]:"Custom"};function L0(i,t){const e=P0[t];return e===void 0?(Dt("WebGLProgram: Unsupported toneMapping:",t),"vec3 "+i+"( vec3 color ) { return LinearToneMapping( color ); }"):"vec3 "+i+"( vec3 color ) { return "+e+"ToneMapping( color ); }"}const sr=new N;function D0(){Yt.getLuminanceCoefficients(sr);const i=sr.x.toFixed(4),t=sr.y.toFixed(4),e=sr.z.toFixed(4);return["float luminance( const in vec3 rgb ) {",`	const vec3 weights = vec3( ${i}, ${t}, ${e} );`,"	return dot( weights, rgb );","}"].join(`
...
`)}function F0(i,t){const e={},n=i.getProgramParameter(t,i.ACTIVE_ATTRIBUTES);for(let s=0;s<n;s++){const r=i.getActiveAttrib(t,s),a=r.name;let o=1;r.type===i.FLOAT_MAT2&&(o=2),r.type===i.FLOAT_MAT3&&(o=3),r.type===i.FLOAT_MAT4&&(o=4),e[a]={type:r.type,location:i.getAttribLocation(t,a),locationSize:o}}return e}function xs(i){return i!==""}function Ic(i,t){const e=t.numSpotLightShadows+t.numSpotLightMaps-t.numSpotLightShadowsWithMaps;return i.replace(/NUM_DIR_LIGHTS/g,t.numDirLights).replace(/NUM_SPOT_LIGHTS/g,t.numSpotLights).replace(/NUM_SPOT_LIGHT_MAPS/g,t.numSpotLightMaps).replace(/NUM_SPOT_LIGHT_COORDS/g,e).replace(/NUM_RECT_AREA_LIGHTS/g,t.numRectAreaLights).replace(/NUM_POINT_LIGHTS/g,t.numPointLights).replace(/NUM_HEMI_LIGHTS/g,t.numHemiLights).replace(/NUM_DIR_LIGHT_SHADOWS/g,t.numDirLightShadows).replace(/NUM_SPOT_LIGHT_SHADOWS_WITH_MAPS/g,t.numSpotLightShadowsWithMaps).replace(/NUM_SPOT_LIGHT_SHADOWS/g,t.numSpotLightShadows).replace(/NUM_POINT_LIGHT_SHADOWS/g,t.numPointLightShadows)}function Pc(i,t){return i.replace(/NUM_CLIPPING_PLANES/g,t.numClippingPlanes).replace(/UNION_CLIPPING_PLANES/g,t.numClippingPlanes-t.numClipIntersection)}const q0=/^[ \t]*#include +<([\w\d./]+)>/gm;function Lo(i){return i.replace(q0,O0)}const V0=new Map;function O0(i,t){let e=Vt[t];if(e===void 0){const n=V0.get(t);if(n!==void 0)e=Vt[n],Dt('WebGLRenderer: Shader chunk "%s" has been deprecated. Use "%s" instead.',t,n);else throw new Error("Can not resolve #include <"+t+">")}return Lo(e)}const B0=/#pragma unroll_loop_start\s+for\s*\(\s*int\s+i\s*=\s*(\d+)\s*;\s*i\s*<\s*(\d+)\s*;\s*i\s*\+\+\s*\)\s*{([\s\S]+?)}\s+#pragma unroll_loop_end/g;function Lc(i){return i.replace(B0,k0)}function k0(i,t,e,n){let s="";for(let r=parseInt(t);r<parseInt(e);r++)s+=n.replace(/\[\s*i\s*\]/g,"[ "+r+" ]").replace(/UNROLLED_LOOP_INDEX/g,r);return s}function Dc(i){let t=`precision ${i.precision} float;
...
#define LOW_PRECISION`),t}const z0={[mr]:"SHADOWMAP_TYPE_PCF",[vs]:"SHADOWMAP_TYPE_VSM"};function G0(i){return z0[i.shadowMapType]||"SHADOWMAP_TYPE_BASIC"}const H0={[vi]:"ENVMAP_TYPE_CUBE",[$i]:"ENVMAP_TYPE_CUBE",[Lr]:"ENVMAP_TYPE_CUBE_UV"};function W0(i){return i.envMap===!1?"ENVMAP_TYPE_CUBE":H0[i.envMapMode]||"ENVMAP_TYPE_CUBE"}const X0={[$i]:"ENVMAP_MODE_REFRACTION"};function Y0(i){return i.envMap===!1?"ENVMAP_MODE_REFLECTION":X0[i.envMapMode]||"ENVMAP_MODE_REFLECTION"}const K0={[Vo]:"ENVMAP_BLENDING_MULTIPLY",[Rd]:"ENVMAP_BLENDING_MIX",[Id]:"ENVMAP_BLENDING_ADD"};function Z0(i){return i.envMap===!1?"ENVMAP_BLENDING_NONE":K0[i.combine]||"ENVMAP_BLENDING_NONE"}function j0(i){const t=i.envMapCubeUVHeight;if(t===null)return null;const e=Math.log2(t)-2,n=1/t;return{texelWidth:1/(3*Math.max(Math.pow(2,e),112)),texelHeight:n,maxMip:e}}function J0(i,t,e,n){const s=i.getContext(),r=e.defines;let a=e.vertexShader,o=e.fragmentShader;const c=G0(e),l=W0(e),h=Y0(e),d=Z0(e),u=j0(e),m=U0(e),g=N0(r),x=s.createProgram();let p,f,M=e.glslVersion?"#version "+e.glslVersion+`
...
`].filter(xs).join(`
`)),a=Lo(a),a=Ic(a,e),a=Pc(a,e),o=Lo(o),o=Ic(o,e),o=Pc(o,e),a=Lc(a),o=Lc(o),e.isRawShaderMaterial!==!0&&(M=`#version 300 es
...
`)+`
`+f);const E=M+p+a,y=M+f+o,w=wc(s,s.VERTEX_SHADER,E),T=wc(s,s.FRAGMENT_SHADER,y);s.attachShader(x,w),s.attachShader(x,T),e.index0AttributeName!==void 0?s.bindAttribLocation(x,0,e.index0AttributeName):e.morphTargets===!0&&s.bindAttribLocation(x,0,"position"),s.linkProgram(x);function R(C){if(i.debug.checkShaderErrors){const D=s.getProgramInfoLog(x)||"",F=s.getShaderInfoLog(w)||"",G=s.getShaderInfoLog(T)||"",V=D.trim(),B=F.trim(),k=G.trim();let Q=!0,j=!0;if(s.getProgramParameter(x,s.LINK_STATUS)===!1)if(Q=!1,typeof i.debug.onShaderError=="function")i.debug.onShaderError(s,x,w,T);else{const ht=Rc(s,w,"vertex"),gt=Rc(s,T,"fragment");Xt("THREE.WebGLProgram: Shader Error "+s.getError()+" - VALIDATE_STATUS "+s.getProgramParameter(x,s.VALIDATE_STATUS)+`
...
void main() {
    ...
    `,t.appendChild(r)}),ft("lb-reset").textContent=`resets in ${Kv(Uv())}`;const e=t.querySelector(".lb-row.player");e&&setTimeout(()=>e.scrollIntoView({block:"center",behavior:"smooth"}),80)}function tx(){hh(sl()),Vn("leaderboard");const i=10,t=il();Bv(50,t).then(e=>{if(!e||e.length<i)return;const n=e.some(r=>r.isPlayer),s=e.map(r=>({name:r.name,flag:"🇧🇷",weekGoals:r.score,isPlayer:r.isPlayer}));if(!n){const r=Qh();s.push({name:Fr()||"YOU",flag:"🇧🇷",weekGoals:r,isPlayer:!0}),s.sort((a,o)=>o.weekGoals-a.weekGoals||(a.isPlayer?1:-1))}hh(s)}).catch(()=>{})}function ex(){const i=ft("ad-content"),t=ft("ad-sub"),e=ft("ad-progress-fill"),n=ft("ad-skip"),s=ft("ad-reward"),r=ft("ad-actions"),a=ft("ad-claim");i.innerHTML="AD<br>IN PROGRESS",t.textContent="hold tight — almost there",e.style.width="0%",s.classList.remove("show"),r.classList.remove("show"),n.textContent="SKIP in 5s",Vn("ads-overlay");const o=5e3,c=performance.now();Zn&&clearInterval(Zn),Zn=setInterval(()=>{const l=performance.now()-c,h=Math.min(100,l/o*100);e.style.width=h+"%";const d=Math.max(0,Math.ceil((o-l)/1e3));if(n.textContent=d>0?`SKIP in ${d}s`:"",l>=o){clearInterval(Zn),Zn=null;const u=Fv();i.innerHTML=u?"AD<br>COMPLETE":"TICKETS<br>AT MAX",t.textContent=u?"reward ready":"come back after spending tickets",u&&(s.textContent=`+${nl} 🎫`,s.classList.add("show")),r.classList.add("show"),a.textContent="OK"}},100)}function nx(){Zn&&(clearInterval(Zn),Zn=null),mn()}function ix(){ft("lobby-play").addEventListener("click",()=>{if(!ah()){Do();return}if(Gi(),he&&he.ftuePending&&he.ftuePending()){ci(),he.startMatch();return}Fa(()=>{ci(),he.startMatch()})}),window.__onTrainingOver=()=>{Fa(()=>{ci(),he.startMatch()})},ft("lobby-ads").addEventListener("click",()=>{eu()&&(Gi(),ex())}),ft("lobby-leaderboard").addEventListener("click",()=>{Gi(),tx()}),ft("lobby-settings").addEventListener("click",()=>{Gi(),jv()}),ft("lobby-notif").addEventListener("click",()=>{Gi(),Jv()}),ft("settings-close").addEventListener("click",()=>mn()),ft("settings-back").addEventListener("click",()=>mn()),ft("settings-sound").addEventListener("change",e=>{zv(e.target.checked)}),ft("settings-bg-volume").addEventListener("input",e=>{const n=parseInt(e.target.value,10);Xv(n),e.target.style.setProperty("--pct",n+"%");const s=ft("settings-bg-volume-pct");s&&(s.textContent=n+"%")}),ft("settings-reset").addEventListener("click",()=>{confirm("Reset all career progress (goals, week stats, tickets)?")&&(localStorage.removeItem("soccer1x1:meta:v1"),location.reload())}),ft("notif-close").addEventListener("click",()=>mn()),ft("notif-back").addEventListener("click",()=>mn()),ft("lb-close").addEventListener("click",()=>mn()),ft("lb-back").addEventListener("click",()=>mn()),ft("ad-claim").addEventListener("click",()=>nx()),ft("endcard-lobby").addEventListener("click",()=>{he.exitToMenu(),mn()}),ft("endcard-replay").addEventListener("click",()=>{qr()<Nr||(ah(),ci(),he.exitToMenu(),Fa(()=>{ci(),he.startMatch()}))});const i=ft("name-prompt-save");i&&i.addEventListener("click",ch);const t=ft("name-prompt-input");t&&t.addEventListener("keydown",e=>{e.key==="Enter"&&(e.preventDefault(),ch())}),ft("pause-resume").addEventListener("click",()=>{ci(),he&&he.setPaused&&he.setPaused(!1)}),ft("pause-surrender").addEventListener("click",()=>{ci(),he&&he.setPaused&&he.setPaused(!1),he&&he.surrenderMatch&&he.surrenderMatch()}),ft("pause-volume").addEventListener("input",e=>{const n=parseInt(e.target.value,10);Hv(n),e.target.style.setProperty("--pct",n+"%");const s=ft("pause-volume-pct");s&&(s.textContent=n+"%")})}function sx(){const i=Gv(),t=ft("pause-volume");t&&(t.value=String(i),t.style.setProperty("--pct",i+"%"));const e=ft("pause-volume-pct");e&&(e.textContent=i+"%"),Vn("pause-menu")}function rx(){window.__onMatchOver=i=>{$v(i)},window.__onPauseRequested=()=>{sx()}}function ax(i){const t=Sv();he=window.__GAME__||window.__game,he||console.error("[meta] startSoccer did not expose the game instance"),i&&i.classList.add("visible");const e=document.getElementById("game-canvas");return e&&e.classList.add("visible"),document.body.style.backgroundImage=`url(${yv})`,document.body.classList.add("lobby-bg"),rx(),ix(),mn(),t}const ox=document.getElementById("game-canvas"),fe=(...i)=>console.log("[Shell]",...i);async function du(){fe("Booting...",`platform=${Ln.getPlatform()}`,`native=${Ln.isNativePlatform()}`);try{await Er().initialize({appId:"soccer1x1-37",environment:"production",playerId:il()}),fe("[WildlifePlatform] initialized, version =",await Er().getPlatformVersion())}catch(t){fe("[WildlifePlatform] initialize failed:",(t==null?void 0:t.message)??t)}Qu(),sd();let i="1.2.5";if(Ln.isNativePlatform()){try{const t=await dh.getInfo();i=t.version||i,fe("Native app info:",JSON.stringify(t))}catch(t){fe("Could not get native app info:",t.message)}if(fe("Entering fullscreen mode..."),await xl.hide(),await xl.setOverlaysWebView({overlay:!0}),await Pu.hide(),fe("Fullscreen + splash hidden"),Ln.getPlatform()==="ios")try{const t=await Lu.requestPermission();fe("[ATT] status:",(t==null?void 0:t.status)??"unknown")}catch(t){fe("[ATT] requestPermission failed:",(t==null?void 0:t.message)??t)}}td(i),fe("Shell version:",i,"| Content version:","1.2.5"),kn.on("status",t=>{fe("OTA status:",t),Us(t)}),kn.on("progress",t=>{fe("OTA progress:",t+"%"),Il(t)}),kn.on("error",t=>fe("OTA error:",t));try{fe("Initializing OTA updater..."),await kn.init(),fe("OTA updater initialized");const t=await kn.getContentVersion();fe("Content version:",t),ed(t),fe("Checking for updates...");const e=await kn.checkForUpdate();if(e){fe("Update manifest:",JSON.stringify(e)),Us("Downloading update..."),await kn.downloadUpdate(e),Us("Applying update..."),fe("Applying update immediately..."),await kn.applyNow();return}else fe("No update available");Us("Starting game..."),Il(100),fe("Launching game..."),await lx(300),ax(ox),fe("Lobby ready — holding splash for 3s"),await new Promise(n=>setTimeout(n,3e3)),fe("Hiding loader"),await id(),fe("Boot complete")}catch(t){console.error("[Shell] Startup error:",t),rd(t.message||"Failed to start the game.",()=>du())}}function lx(i){return new Promise(t=>setTimeout(t,i))}du();export{uh as W};
